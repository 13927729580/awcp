 ...
 *
 */
public class PunResource extends BaseEntity<Long> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("resourceId", getResourceId())
				.append("SysId", getSysId()).append("RelateResoId", getRelateResoId())
				.append("ResouType", getResouType()).append("WhichEnd", getWhichEnd()).toString();
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof PunResource == false)
			return false;
		if (this == obj)
			return true;
	...
	public PunResource save() {
		return PunResource.getRepository().save(this);
	}
