...
public class PunGroupSys extends BaseEntity<Long> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("GroupSysId", getGroupId())
				.append("GroupId", getGroupId()).append("SysId", getSysId()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getGroupSysId()).append(getGroupId()).append(getSysId()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof PunGroupSys == false)
			return false;
		if (this == obj)
			return true;
		PunGroupSys other = (PunGroupSys) obj;
		return new EqualsBuilder().append(getGroupId(), other.getGroupId()).append(getSysId(), other.getSysId())
				.append(getGroupSysId(), other.getGroupSysId()).isEquals();
	}
	...
	public PunGroupSys save() throws MRTException {
		return PunGroupSys.getRepository().save(this);
	}
