 ...
 *
 */
public class PdataDictionary extends BaseEntity<Long> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("Id", getId()).append("Code", getCode())
				.append("DataKey", getDataKey()).append("DataValue", getDataValue()).append("DataOrder", getDataOrder())
				.append("DictRemark", getDictRemark()).append("Level", getDictRemark()).toString();
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof PdataDictionary == false)
			return false;
		if (this == obj)
			return true;
	...
	public PdataDictionary save() {
		return PdataDictionary.getRepository().save(this);
	}
