 ...
 *
 */
public class PunSystem extends BaseEntity<Long> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("SysId", getSysId())
				.append("SysAddress", getSysAddress()).append("SysName", getSysName())
				.append("SysShortName", getSysShortName()).append("SysCreater", getSysCreater())
				.append("SysCreateTime", getSysCreateTime()).append("groupId", getGroupId())
				.append("sysCreateGroup", getSysCreateGroup()).append("sysStatus", getSysStatus()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getSysId()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof PunSystem == false)
			return false;
		if (this == obj)
			return true;
		PunSystem other = (PunSystem) obj;
		return new EqualsBuilder().append(getSysId(), other.getSysId()).isEquals();
	}
	...
	public PunSystem save() throws MRTException {
		return PunSystem.getRepository().save(this);
	}
