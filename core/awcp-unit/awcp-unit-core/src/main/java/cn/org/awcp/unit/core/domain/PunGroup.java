 ...
 *
 */
public class PunGroup extends BaseEntity<Long> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("GroupId", getGroupId())
				.append("ParentGroupId", getParentGroupId()).append("GroupType", getGroupType())
				.append("GroupChName", getGroupChName()).append("GroupShortName", getGroupShortName())
				.append("GroupEnName", getGroupEnName()).append("OrgCode", getOrgCode())
				.append("GroupAddress", getGroupAddress()).append("ZipCode", getZipCode())
				.append("ContactNumber", getContactNumber()).append("Fax", getFax())
				.append("GroupBusinessSphere", getGroupBusinessSphere()).append("CreateDate", getCreateDate())
	...
	public boolean equals(Object obj) {
		if (obj instanceof PunGroup == false)
			return false;
		if (this == obj)
			return true;
	...
	public PunGroup save() {
		return PunGroup.getRepository().save(this);
	}
