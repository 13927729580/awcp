 ...
 *
 */
public class PunRoleAccess extends BaseEntity<Long> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("RoleId", getRoleId())
				.append("ResourceId", getResourceId()).append("OperType", getOperType()).toString();
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getRoleId()).append(getResourceId()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof PunRoleAccess == false)
			return false;
		if (this == obj)
			return true;
		PunRoleAccess other = (PunRoleAccess) obj;
		return new EqualsBuilder().append(getRoleId(), other.getRoleId()).append(getResourceId(), other.getResourceId())
				.isEquals();
	}

	public PunRoleAccess save() {
		return PunRoleAccess.getRepository().save(this);
	}
