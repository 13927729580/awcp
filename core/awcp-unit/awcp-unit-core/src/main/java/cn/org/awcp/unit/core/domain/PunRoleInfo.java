 ...
 *
 */
public class PunRoleInfo extends BaseEntity<Long> {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("RoleId", getRoleId())
				.append("SysId", getSysId()).append("RoleName", getRoleName()).append("DictRemark", getDictRemark())
				.toString();
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof PunRoleInfo == false)
			return false;
		if (this == obj)
			return true;
	...
	public PunRoleInfo save() throws MRTException {
		return PunRoleInfo.getRepository().save(this);
	}
