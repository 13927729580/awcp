...
public class PunPositionServiceImpl implements PunPositionService {
	...
	// 根据字段排序("name.asc")列子
	public PageList<PunPositionVO> selectPagedByExample(String queryStr, Map<String, Object> params, int currentPage,
			int pageSize, String sortString) {
		PageList<PunPosition> result = queryChannel.queryPagedResult(PunPosition.class, queryStr, params, currentPage,
				pageSize, sortString);
		PageList<PunPositionVO> resultVO = new PageList<PunPositionVO>(result.getPaginator());
