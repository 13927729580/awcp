...
public class AuthorityCompoentServiceImpl implements AuthorityCompoentService {
	...
	public AuthorityCompoentVO findById(String id) {
		AuthorityCompoentVO vo = BeanUtils.getNewInstance(AuthorityCompoent.get(AuthorityCompoent.class, id),
				AuthorityCompoentVO.class);
		return vo;
	}

	public AuthorityCompoentVO findByComponent(String componentId) {

		AuthorityCompoentVO vo = BeanUtils.getNewInstance(AuthorityCompoent.getByComponent(componentId),
				AuthorityCompoentVO.class);
		return vo;
	}
	...
	public List<AuthorityCompoentVO> queryResult(String queryStr, Map<String, Object> params) throws MRTException {
		List<AuthorityCompoent> resources = queryChannel.queryResult(AuthorityCompoent.class, queryStr, params);
