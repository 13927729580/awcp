...
public class AuthorityGroupWorkFlowNodeServiceImpl implements AuthorityGroupWorkFlowNodeService {
	...
	public AuthorityGroupWorkFlowNodeVO findById(String id) {
		AuthorityGroupWorkFlowNodeVO vo = BeanUtils.getNewInstance(
				AuthorityGroupWorkFlowNode.get(AuthorityGroupWorkFlowNode.class, id),
	...
	@Override
	public List<AuthorityGroupWorkFlowNodeVO> queryResult(String queryStr, Map<String, Object> params)
			throws MRTException {
		List<AuthorityGroupWorkFlowNode> resources = queryChannel.queryResult(AuthorityGroupWorkFlowNode.class,
				queryStr, params);
