...
public class SuggestionServiceImpl implements SuggestionService {
	...
	public SuggestionVO findById(String id) {
		SuggestionVO vo = BeanUtils.getNewInstance(Suggestion.get(Suggestion.class, id), SuggestionVO.class);
		return vo;
	}

	@Override
	public PageList<SuggestionVO> queryPagedResult(String queryStr, Map<String, Object> params, int currentPage,
		...
		PageList<SuggestionVO> groups = queryChannel.queryPagedResult(SuggestionVO.class, queryStr, params, currentPage,
				pageSize, sortString);
	...
	@Override
	public PageList<SuggestionVO> selectPagedByExample(BaseExample example, int currentPage, int pageSize,
			String sortString) {
		Object obj = Tools.getObjectFromSession(SessionContants.TARGET_SYSTEM);
		...
		PageList<Suggestion> list = queryChannel.selectPagedByExample(Suggestion.class, example, currentPage, pageSize,
				sortString);
	...
	public boolean delete(String[] ids) {
		try {
			for (String id : ids) {
				Suggestion au = BeanUtils.getNewInstance(Suggestion.get(Suggestion.class, id), Suggestion.class);
				au.remove();
			}
			return true;
		} catch (Exception e) {
