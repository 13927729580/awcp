...
public class PfmTemplateServiceImpl implements PfmTemplateService {
	...
	// 根据字段排序("name.asc")列子
	public PageList<PfmTemplateVO> queryPagedResult(Map<String, Object> params, int currentPage, int pageSize,
			String sortString) {
		PageList<PfmTemplate> result = queryChannel.queryPagedResult(PfmTemplate.class, "queryList", params,
	...
	public PfmTemplateVO get(String id) {
		try {
	...
	public List<PfmTemplateVO> queryResult(String queryStr, Map<String, Object> params) {
		List<PfmTemplate> result = queryChannel.queryResult(PfmTemplate.class, queryStr, params);
	...
	public PageList<PfmTemplateVO> selectPagedByExample(BaseExample baseExample, int currentPage, int pageSize,
			String sortString) {
		PageList<PfmTemplate> result = queryChannel.selectPagedByExample(PfmTemplate.class, baseExample, currentPage,
				pageSize, sortString);
		PageList<PfmTemplateVO> resultVO = new PageList<PfmTemplateVO>(result.getPaginator());
		for (PfmTemplate dd : result) {
			resultVO.add(BeanUtils.getNewInstance(dd, PfmTemplateVO.class));
