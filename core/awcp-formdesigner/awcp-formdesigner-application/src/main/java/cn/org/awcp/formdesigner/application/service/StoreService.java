...
public interface StoreService {
	...
	/**
	 * 
	 * @Title: save @Description: 保存或更新 @param vo @return String 数据库id @throws
	 */
	public String save(StoreVO vo);

	/**
	 * @Title: delete @Description: 物理删除 @param vo @return boolean @throws
	 */
	public boolean delete(StoreVO vo);

	/**
	 * 
	 * @Title: deleteLikeCode @Description: 按照code(code用于区分类型）删除 @param code @return
	 *         boolean @throws
	 */
	public boolean deleteLikeCode(String code);

	/**
	 * @Title: logicDeleteLikeCode @Description: 按照Code模糊删除 @param code @return
	 *         boolean @throws
	 */
	public StoreVO findById(String id);

	/**
	 * @Title: findByCode @Description: 按照code查找 @param id @return StoreVO @throws
	 */
	 ...
	 * @return
	 */
	public PageList<StoreVO> findByDyanamicPageId(String dyanamicPageId);
	 ...
	 * @return
	 */
	public List<StoreVO> copyByDynamicPageId(String sourceId, String targetId);
	...
	/**
	 * @Title: queryPagedResult @Description: 分页查找 可以按照指定字段排序 @param params
	 *         参数 @param currentPage 当前页 @param pageSize 每页数 @param sortString
	 *         排序 @return PageList<StoreVO> @throws
	 */
	 ...
	 *         排序字段 @return PageList<StoreVO> @throws
	 */
	...
	/**
	 * 
	 * @Title: copy @Description: 对数据进行拷贝 @param actIds @param dynamicPageId @param
	 *         order @return List<StoreVO> @throws
	 */
	public List<StoreVO> copy(String actIds, String dynamicPageId, int order);
	 ...
	 * @return
	 */
	PageList<JSONObject> findComponentByDyanamicPageId(String dyanamicPageId);

	PageList<JSONObject> findParentComponentByDyanamicPageId(String dyanamicPageId);
