...
/**
 * 包含模型、页面组件、动作 CRUD操作+预览操作
 */
public class DynamicPage extends PageObject<String> {
	...
	/**
	 * 页面类型 普通页面：无form标签包裹 表单页面：有form标签包裹，有配置信息
	 * 文档页面：有配置信息，有form标签包裹，有页面设计信息（页眉页脚页码，纸张大小等等），转换成pdf时，会根据配置等按模版转换成pdf
	 * 复合页面：可能会有多个form标签，相互会有联系 PageObjectType
	 */
