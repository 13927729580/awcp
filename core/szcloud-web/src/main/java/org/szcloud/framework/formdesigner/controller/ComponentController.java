...
public class ComponentController extends BaseController {
	...
	public boolean checkComponentNameInPage(Long dynamicPageId, String componentName, String componentId) {
	...
	public String refreshContainerComponent(@RequestParam(value = "_selects") String selects, String alias) {
		...
		if (ids != null && ids.length > 0) {
			for (int j = 0; j < ids.length; j++) {
				...
				List<JSONObject> components = storeService.findComponentByDyanamicPageId(Long.parseLong(pageId));
	...
	public ModelAndView toEditComponent(Long dynamicPageId, String componentType, String componentId) {
	...
	public ModelAndView perComponentsedit(Long dynamicPageId, @RequestParam(value = "_selects") String selects) {
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView toEditComponents(Long dynamicPageId, String componentType, String componentId,
	...
	public String quickComByData(@RequestParam(value = "_dataSource") String dataSources,
			...
			@RequestParam(value = "_labelLayoutName") String labelLayoutNames, Long dynamicPageId) {
