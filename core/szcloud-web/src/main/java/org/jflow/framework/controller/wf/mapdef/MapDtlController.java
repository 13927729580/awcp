...
public class MapDtlController {
	...
	public void doSave(HttpServletRequest request, boolean isCancel) {
		...
		try {
			...
			if (StringHelper.isNullOrEmpty(getDoType()) || getDoType().equals("New")) {
				...
				BaseModel.sendRedirect(
						"MapDtl.jsp?DoType=Edit&FK_MapDtl=" + dtlN.getNo() + "&FK_MapData=" + this.getFK_MapData());
				...
				BaseModel.sendRedirect(
						"MapDtl.jsp?DoType=Edit&FK_MapDtl=" + dtl.getNo() + "&FK_MapData=" + this.getFK_MapData());
			}
	...
	public @ResponseBody void mapAthMapDtl() {
		...
		BaseModel.sendRedirect(
				"Attachment.jsp?DoType=Edit&FK_MapData=" + this.getFK_MapDtl() + "&UploadType=1&Ath=AthM");
	}
	...
	// dtl.IntMapAttrs();
	//
	// BaseModel.sendRedirect("MapDtlDe.jsp?DoType=Edit&FK_MapData=" +
	// this.getFK_MapData() + "&FK_MapDtl=" + this.getFK_MapDtl());
	// }
