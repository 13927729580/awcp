     ...
     public void InsertObjects(boolean isJudgeRowIdx)
     {
        ...
        // #region 增加附件
    	 for (int i = 0; i < this.get_aths().size(); i++) {
            ...
            String src = "../CCForm/AttachmentUpload.aspx?PKVal=0&Ath=" + dtl.getNoOfObj() + "&FK_MapData=" + this.FK_MapData + "&FK_FrmAttachment=" + dtl.getMyPK();
        ...
        // #endregion 增加M2M
    	 ...
    	 for (int i = 0; i < this.get_frams().size(); i++) {
             ...
             String src = fram.getURL(); // "MapDtlDe.aspx?DoType=Edit&FK_MapData=" + this.FK_MapData + "&FK_MapDtl=" + fram.No;
             if (src.contains("?"))
