...
public class ConditionModel {
	...
	public ConditionModel(String CurrentCond, String CondType, String FK_Flow, String FK_MainNode, String FK_Node,
			String FK_Attr, String DirType, String ToNodeId) {
	...
	// private Dictionary<ConnDataFrom, string> DataFrom = new
	// Dictionary<ConnDataFrom, string>()
	// {
	...
	public void init() {
		logger.debug(this.CondType);
		Cond cond = new Cond();
		if (cond.Retrieve(CondAttr.NodeID, this.FK_Node, CondAttr.ToNodeID, this.ToNodeID) != 0) {
			CurrentCond = DataFrom.get(cond.getHisDataFrom());// [cond.HisDataFrom];
		}
	}
}
