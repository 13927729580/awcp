...
//				ddl.AutoPostBack = true;
				...
				for (BP.WF.XML.DefVal def : DefVals.convertDefVals(vals))
				{
...
//		btn.Click += new EventHandler(btn_Save_Click);
		...
		if (this.getRefNo() != null)
		{
			...
			this.Pub1.append("<input type=button class=Btn value='扩展设置' onclick=\"javascript:WinOpen('AutoFull.jsp?RefNo=" + this.getRefNo() + "&FK_MapData=" + mapAttr.getFK_MapData() + "',''); return false;\" />");
...
//		ddlBig.setId("DDL_TBModel");
//		ddlBig.setName("DDL_TBModel");
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	public final String getGetCaption()
	{
		...
		{
			return "<a href='Do.jsp?DoType=ChoseFType&MyPK=" + this.getMyPK() + "&RefNo=" + this.getRefNo() + "&GroupField=" + this.getGroupField() + "'>返回类型选择</a> - " + "编辑";
		}
	}
