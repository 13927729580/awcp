...
//				throw new RuntimeException("您没有能参数: [ " + key + " ," + val + " ] 给值 ，URL 将不能被执行。");
				return;
			}

//			switch (str)
			if (key.equals(DoWhatList.DoNode) || key.equals(DoWhatList.Emps) || key.equals(DoWhatList.EmpWorks) || key.equals(DoWhatList.FlowSearch) || key.equals(DoWhatList.Login) || key.equals(DoWhatList.MyFlow) || key.equals(DoWhatList.MyWork) || key.equals(DoWhatList.Start) || key.equals(DoWhatList.Start5) || key.equals(DoWhatList.JiSu) || key.equals(DoWhatList.StartSmall) || key.equals(DoWhatList.FlowFX) || key.equals(DoWhatList.DealWork) || key.equals(DoWhatList.DealWorkInSmall) || key.equals("FK_Flow") || key.equals("WorkID") || key.equals("FK_Node") || key.equals("SID"))
			{
...
//						throw new RuntimeException("@参数 FK_Flow 或者 WorkID 为Null 。");
					...
					sendRedirect("/WF/WFRpt.jsp?FK_Flow=" + this.getFK_Flow() + "&WorkID=" + this.getWorkID() + "&o2=1" + paras);
			}
...
//				else
//				{
//					sendRedirect("./App/Simple/Default.jsp?FK_Flow=" + this.getFK_Flow() + paras + "&FK_Node=" + nodeID);
//				}
...
//					else
//					{
//						//sendRedirect("./Default.jsp?FK_Flow=" + this.getFK_Flow() + paras + "&FK_Node=" + nodeID);
...
//					else
//					{
//						sendRedirect("../AppDemoLigerUI/Default.jsp?FK_Flow=" + this.getFK_Flow() + paras + "&FK_Node=" + nodeID);
//					}
//			}
...
//					else
//					{
//						sendRedirect("./App/Amaz/Default.jsp?FK_Flow=" + this.getFK_Flow() + paras + "&FK_Node=" + nodeID);
//					}
//			}
			...
			else if (this.getDoWhat().equals(DoWhatList.FlowSearch)) // 流程查询。
			{
					...
					{
						sendRedirect("/Rpt/Search.jsp?Endse=s&FK_Flow=001&EnsName=ND" + Integer.parseInt(this.getFK_Flow()) + "Rpt" + paras);
					}
			}
