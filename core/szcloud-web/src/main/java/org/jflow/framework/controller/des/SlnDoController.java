...
public class SlnDoController extends BaseController {
	...
	public void btn_Click(TempObject object, HttpServletRequest request, HttpServletResponse response) {
		...
		sln.Retrieve(FrmFieldAttr.FK_MapData, object.getFK_MapData(), FrmFieldAttr.KeyOfEn, object.getKeyOfEn(),
				FrmFieldAttr.FK_Node, this.getFK_Node());
