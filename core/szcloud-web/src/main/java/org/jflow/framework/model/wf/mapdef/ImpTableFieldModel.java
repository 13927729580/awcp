package org.jflow.framework.model.wf.mapdef;
...
public class ImpTableFieldModel extends BaseModel {
	...
	public void loadPage() {
		...
		if (this.getStep() == 1) {
			...
			for (SFDBSrc item : SFDBSrcs.convertSFDBSrcs(ens)) {
			...
			Pub1.append(AddLi("<div><a href=\"javascript:WinOpen('/WF/Comm/RefFunc/UIEn.jsp?EnsName=BP.Sys.SFDBSrcs')\" ><img src='../Img/New.gif' align='middle' /><span class='nav'>新建数据源</span></a></div>"));
