...
public class DoModel extends BaseModel {
	...
	public void init() {
		try {
			if (DoType.equals("DownTempFrm")) {
				...
				String file = ContextHolderUtils.getRequest().getRealPath("/") + "Temp" + File.separator
						+ this.FK_MapData + ".xml";
				ds.WriteXml(file);
			...
			if (DoType.equals("CCForm")) {
				...
				if (!WebUser.getNoOfRel().equals(SystemConfig.getAppSettings().get("Admin").toString())) {
				...
				if (i == 0) {
					// mattr.setName(value); =
					// System.Web.HttpUtility.UrlDecode(this.Request.QueryString["KeyName"],System.Text.Encoding.GetEncoding("GB2312"));
				...
				// this.Response.Redirect("EditF.aspx?RefNo=" + this.RefNo,
				// true);
				// return;
				// case FieldTypeS.FK:
				// this.Response.Redirect("EditTable.aspx?RefNo=" + this.RefNo,
				// true);
				// return;
				// case FieldTypeS.Enum:
				// this.Response.Redirect("EditEnum.aspx?RefNo=" + this.RefNo,
				// true);
				// return;
				// default:
				// return;
				...
				response.sendRedirect("EditTable.aspx?MyPK=" + this.MyPK + "&SFKey=" + sf.getNo());
				// this.WinClose();
				return;
				...
				if (RefNo.equals("IsPass")) {
					...
					attr.setName("BatchID");// this.ToE("IsPass", "是否通过");//
											// "审核人";
				...
				// response.sendRedirect(this.Request.RawUrl.Replace("MoveTo",
				// "Jump"), true);
				return;
			...
			// this.Pub1.AddMsgOfWarning("错误:", ex.getMessage() + " <br>" +
			// this.Request.RawUrl);
		}
	}
	...
	public void AddF() {
		...
		// this.Pub1.AddUL();
		// this.Pub1.AddLi("<a href='EditF.aspx?DoType=Add&MyPK=" + this.MyPK +
		// "&FType=" + BP.DA.DataType.AppString + "&IDX=" + this.IDX +
		// "&GroupField=" + this.GroupField + "'><b>字符型</b></a> - <font
		// color=Note>如:姓名、地址、邮编、电话</font>");
		// this.Pub1.AddLi("<a href='EditF.aspx?DoType=Add&MyPK=" + this.MyPK +
		// "&FType=" + BP.DA.DataType.AppInt + "&IDX=" + this.IDX +
		// "&GroupField=" + this.GroupField + "'><b>整数型</b></a> - <font
		// color=Note>如:年龄、个数。</font>");
		// this.Pub1.AddLi("<a href='EditF.aspx?DoType=Add&MyPK=" + this.MyPK +
		// "&FType=" + BP.DA.DataType.AppMoney + "&IDX=" + this.IDX +
		// "&GroupField=" + this.GroupField + "'><b>金额型</b></a> - <font
		// color=Note>如:单价、薪水。</font>");
		// this.Pub1.AddLi("<a href='EditF.aspx?DoType=Add&MyPK=" + this.MyPK +
		// "&FType=" + BP.DA.DataType.AppFloat + "&IDX=" + this.IDX +
		// "&GroupField=" + this.GroupField + "'><b>浮点型</b></a> - <font
		// color=Note>如：身高、体重、长度。</font>");
		// this.Pub1.AddLi("<a href='EditF.aspx?DoType=Add&MyPK=" + this.MyPK +
		// "&FType=" + BP.DA.DataType.AppDate + "&IDX=" + this.IDX +
		// "&GroupField=" + this.GroupField + "'><b>日期型</b></a> - <font
		// color=Note>如：出生日期、发生日期。</font>");
		// this.Pub1.AddLi("<a href='EditF.aspx?DoType=Add&MyPK=" + this.MyPK +
		// "&FType=" + BP.DA.DataType.AppDateTime + "&IDX=" + this.IDX +
		// "&GroupField=" + this.GroupField + "'><b>日期时间型</b></a> - <font
		// color=Note>如：发生日期时间</font>");
		// this.Pub1.AddLi("<a href='EditF.aspx?DoType=Add&MyPK=" + this.MyPK +
		// "&FType=" + BP.DA.DataType.AppBoolean + "&IDX=" + this.IDX +
		// "&GroupField=" + this.GroupField + "'><b>Boole型(是/否)</b></a> - <font
		// color=Note>如：是否完成、是否达标</font>");
		// this.Pub1.AddULEnd();
		// this.Pub1.AddFieldSetEnd();
		//
		// this.Pub1.AddFieldSet("新增枚举字段(用来表示，状态、类型...的数据。)");
		// this.Pub1.AddUL();
		// this.Pub1.AddLi("<a href='Do.aspx?DoType=AddSysEnum&MyPK=" +
		// this.MyPK + "&IDX=" + this.IDX + "&GroupField=" + this.GroupField +
		...
		// this.Pub1.AddUL();
		// this.Pub1.AddLi("<a href='Do.aspx?DoType=AddSFTable&MyPK=" +
		// this.MyPK + "&FType=Class&IDX=" + this.IDX + "&GroupField=" +
		// this.GroupField + "'><b>外键型</b></a> - 比如：岗位、税种、行业、经济性质。");
		// this.Pub1.AddULEnd();
		// this.Pub1.AddFieldSetEnd();
		//
		// this.Pub1.AddFieldSet("<div onclick=\"javascript:HidShowSysField();\"
		// >系统约定字段-隐藏/显示</div> ");
		// string info =
		// DataType.ReadTextFile2Html(BP.Sys.SystemConfig.PathOfData +
		// "SysFields.txt");
		// this.Pub1.Add("<div id='SysField' style='display:none' >" + info +
		// "</div>");
		// this.Pub1.AddFieldSetEnd();
	}
	...
	public void AddFEnum() {
		// this.Title = "增加新字段向导";
		// this.Pub1.AddTable();
		// this.Pub1.AddCaptionLeft("<a href='Do.aspx?DoType=AddF&MyPK=" +
		// this.MyPK + "&IDX=" + this.IDX + "'>增加新字段向导</a> - <a
		// href='SysEnum.aspx?DoType=New&MyPK=" + this.MyPK + "&IDX=" + this.IDX
		...
		// "Do.aspx?DoType=AddSysEnum&MyPK=" + this.MyPK + "&IDX=&GroupField");
		...
		// this.Pub1.AddTD("<a href=\"javascript:AddEnum('" + this.MyPK + "','"
		// + this.IDX + "','" + sem.No + "')\" >" + sem.No + "</a>");
		// this.Pub1.AddTD(sem.Name);
		// this.Pub1.AddTD("[<a href='SysEnum.aspx?DoType=Edit&MyPK=" +
		// this.MyPK + "&IDX=" + this.IDX + "&RefNo=" + sem.No + "' >编辑</a>]");
		// this.Pub1.AddTD(ddl);
		// this.Pub1.AddTREnd();
		// }
	...
	public void AddFGroup() {
		...
		// {
		// this.Pub1.AddLi("<a href='Do.aspx?DoType=AddFG&RefNo=" + en.No +
		// "&FK_MapData=" + this.FK_MapData + "' >" + en.Name + "</a><br>" +
		// en.Desc);
		// }
		// this.Pub1.AddULEnd();
		// this.Pub1.AddFieldSetEnd();
	...
	public void AddSFTable() {
		...
		//
		// this.Pub1.AddTable();
		// this.Pub1.AddCaption("<a href='Do.aspx?DoType=AddF&MyPK=" + this.MyPK
		// + "&IDX=" + this.IDX + "'>增加新字段向导</a> - 增加外键字段 - <a
		// href='SFTable.aspx?DoType=New&MyPK=" + this.MyPK + "&IDX=" + this.IDX
		// + "' > 新建表</a>");
		// this.Pub1.AddTR();
		// this.Pub1.AddTDTitle("IDX");
		// this.Pub1.AddTDTitle("编号(点击增加到表单)");
		...
		// is1 = this.Pub1.AddTR(is1);
		// this.Pub1.AddTDIdx(idx);
		// this.Pub1.AddTD("<a href=\"javascript:AddSFTable('" + this.MyPK +
		// "','" + this.IDX + "','" + sem.No + "')\" >" + sem.No + "</a>");
		// this.Pub1.AddTD(sem.Name);
		//
		// if (sem.IsClass)
		// this.Pub1.AddTD("<a
		// href=\"javascript:WinOpen('../Comm/Search.aspx?EnsName=" + sem.No +
		// "','sg')\" ><img src='../Img/Btn/Edit.gif' border=0/>" +
		// sem.TableDesc + "</a>");
		// else
		// this.Pub1.AddTD("<a
		// href=\"javascript:WinOpen('SFTable.aspx?DoType=Edit&MyPK=" +
		// this.MyPK + "&IDX=" + this.IDX + "&RefNo=" + sem.No + "','sg')\"
		// ><img src='../Img/Btn/Edit.gif' border=0/>" + sem.TableDesc +
		// "</a>");
		//
		// if (sem.No.Contains("."))
		// this.Pub1.AddTD("&nbsp;");
		// else
		// this.Pub1.AddTD("<a
		// href=\"javascript:WinOpen('SFTableEditData.aspx?RefNo=" + sem.No +
		// "');\" >编辑</a>");
		// this.Pub1.AddTREnd();
		// }
		// this.Pub1.AddTableEnd();
