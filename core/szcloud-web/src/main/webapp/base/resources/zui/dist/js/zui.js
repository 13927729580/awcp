...
(function($, window, Math)
{
    ...
    $.extend(
    {
		...
		fnAlert:function(str)
		{
			if(!str)
			{
				throw new Error('fnAlert param requires');
			}
			if(errorMessage[str])
			{
				alert(errorMessage[str]);
			}	
			else
			{
				alert(str);
...
(function($)
{
    ...
    DataTable.DEFAULTS = {
        ...
        fixedLeftWidth: '100%',  // set left width after first render
        fixedRightWidth: '100%', // set right width after first render
    ...
    $.fn.datatable = function(option)
    {
        ...
        {
            var $this = $(this);
            var tr = option.datareload;
			if(option.datareload){
				var data;
			}
			else{
...
/*
$('head').append('<script src="/szcloud/resources/scripts/jquery.cookies.js"/></script>');

  var cookie_style = $.cookie("age"); 
    //alert(cookie_style);
	if(cookie_style>=50){ 
	
		$("link[label=defb]").attr("href","./resources/styles/zTreeStyle/zTreeStyle50.css");
		$("link[label=defa]").attr("href","./resources/plugins/zui/dist/css/zui.min50.css");
		//$("link[label=defc]").attr("href","./resources/styles/main50.css");
		$("link[label=defd]").attr("href","./resources/styles/style50.css");
		$("link[label=defe]").attr("href","./resources/styles/szCloud_common50.css");
		
		$(function(){
			
			
			$("table.table").css("font-size","20px");
			...
			$(".sysname").css("font-size","38px");
			$(".btn").each(function() {
		        $(this).css("font-size","20px");
			})
			$("#LogoBar").css("font-size","20px");
