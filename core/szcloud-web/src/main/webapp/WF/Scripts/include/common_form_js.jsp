<script type="text/javascript" src="<script src="<%=basePath %>resources/JqEdition/jquery-2.2.3.min.js" type="text/javascript"></script>"></script>
...
<script type="text/javascript" src="<%=basePath%>resources/scripts/dev.common.js"></script>
