...
<%@page import="org.jflow.framework.model.wf.admin.BindFrmsModel"%>
...
<script type="text/javascript">
	...
	function BindFrms(nodeid, fk_flow) {
		var url = "BindFrms.jsp?FK_Node=" + nodeid + '&FK_Flow=' + fk_flow
				+ '&DoType=SelectedFrm';
	...
	function WinDtl(fk_mapdata, nodeid, fk_flow) {
		var url = "../MapDef/Sln.jsp?FK_MapData=" + fk_mapdata + "&FK_Node="
				+ nodeid + '&FK_Flow=' + fk_flow + '&DoType=Dtl';
		WinOpen(url);
	}

	function ToolbarExcel(fk_mapdata, nodeid, fk_flow) {
		var pk = fk_mapdata + '_' + nodeid + '_' + fk_flow;
		var url = "../Comm/RefFunc/UIEn.jsp?EnName=BP.Sys.ToolbarExcelSln&PK="
				+ pk;
		WinOpen(url);
	}
	...
	function ToolbarWord(fk_mapdata, nodeid, fk_flow) {
		var pk = fk_mapdata + '_' + nodeid + '_' + fk_flow;
		var url = "../Comm/RefFunc/UIEn.jsp?EnName=BP.Sys.ToolbarWordSln&PK="
				+ pk;
		WinOpen(url);
	}
