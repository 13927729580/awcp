...
<body>
	<form method="post"
		...
		<div
			...
			<table style="text-align: left; width: 100%" class="am-table am-table-striped am-table-hover table-main">
			...
			<div class="am-margin">
						<button type="button" name="Btn_OK" id="Btn_OK"
								...
								<!-- <input type="submit" name="Btn_OK"
									...
									onclick="window.location.go(-1);" id="Btn_Cancel" class="am-btn am-btn-primary am-btn-xs">取消</button>
