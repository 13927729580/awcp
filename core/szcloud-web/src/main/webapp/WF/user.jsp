		...
		<div class="am-g">
			...
			<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
				<form class="am-form am-form-horizontal">
					...
					<div class="am-form-group">
						<label for="user-name" class="am-u-sm-3 am-form-label">文件
							/ File</label>
						<div class="am-u-sm-9">
							<input type="file" id="user-pic"> <small>请选择要上传的文件...</small>
						</div>
					</div>
					...
					<div class="am-form-group">
						<label for="user-name" class="am-u-sm-3 am-form-label">性别
							/ Sex</label>
						<div class="am-u-sm-9">
							<input type="radio" id="user-name" checked="checked">男
							<input type="radio" id="user-name">女
						</div>
					</div>
