...
if (browser=="IE"){
	...
	document.write('codebase="officecontrol/ofctnewclsid.cab#version=5,0,2,2" width="100%" height="100%">   ');
...
document.write('<param name="ProductCaption" value="深圳市科技创新委员会">   ');
document.write('<param name="ProductKey" value="CB47DC13EBA4551F93ACC051EEA97B902C873B99">  ');
	...
	document.write('</object>');
		...
		document.write('<object id="TANGER_OCX" type="application/ntko-plug"  codebase="officecontrol/ofctnewclsid.cab#version=5,0,2,2" width="100%" height="100%" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete" ForOndocumentopened="OnComplete3"');
...
document.write('_ProductCaption="深圳市科技创新委员会"   ');
document.write('_ProductKey="CB47DC13EBA4551F93ACC051EEA97B902C873B99"  ');
...
document.write('_ProductKey="CB47DC13EBA4551F93ACC051EEA97B902C873B99"  ');
		...
		document.write('codebase="officecontrol/ofctnewclsid.cab#version=5,0,2,2" width="100%" height="100%" type="application/ntko-plug" ');
		document.write('_IsUseUTF8URL="-1"   ');
		document.write('_IsUseUTF8Data="-1"   ');
		document.write('_BorderStyle="1"   ');
		document.write('_BorderColor="14402205"   ');
