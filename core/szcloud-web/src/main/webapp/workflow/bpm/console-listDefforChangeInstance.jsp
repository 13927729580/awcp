	...
	<body id="main">
		<div class="container-fluid">
			...
			<div class="row" id="buttons">
				...
				<button type="button" class="btn btn-info" id="addBtn"><i class="icon-edit"></i>新建版本</button>
				<!--  
				<button type="button" class="btn btn-success" id="viewBtn"><i class="icon-edit"></i>查看资源</button>-->
				<button type="button" class="btn btn-success" id="useTaskBtn"><i class="icon-edit"></i>更换到任务</button>
		  ...
		  $(function(){
			...
			$("#viewBtn").click(function(){
      		...
      		$("#useTaskBtn").click(function(){
      			if(count == 1){
      				$("#createForm").attr("action","console-ChangeDefforInstance.do").submit();
      			}else{
      				alertMessage("请选择某个资源进行操作");
      			}
      			return false;
