	...
	<body id="main">
		<div class="container-fluid">
			...
			<div class="row" id="datatable">
			    <form  method="post" id="createForm" action="workspace-listRunningProcessInstances.do">	
					...
					<c:forEach items="${models}" var="item">
				      <tr>
				        ...
				        <td>
				          ...
				          <a href="workspace-endProcessInstance.do?id=${item.id}">终止</a>
				        </td>
				      </tr>
				      </c:forEach>
					</tbody>
