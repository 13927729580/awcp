...
<html lang="en">
  ...
  <head>
    ...
    <script type="text/javascript" src="${scopePrefix}/workflow/widgets/gef/designer-bpmn2-packed.js"></script>
    <script type='text/javascript' src='${scopePrefix}/workflow/widgets/gef/container-layout.js'></script>
    <script type='text/javascript' src='${scopePrefix}/workflow/widgets/gef/adaptor.js'></script>
    ...
    <section style="width: 98%;margin: 0 auto;">
	  <div id="__gef_container__" style="padding-left:5px;">
	    <div id="__gef_toolbar__">
		  ...
		  <div class="btn-group">
		    <button class="btn btn-small" onclick="Gef.activeEditor.reset()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/New-16x16.png">新建</button>
		    <button class="btn btn-small" onclick="doImport()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Properties_16x16.png">导入</button>
		    <button class="btn btn-small" onclick="doExport()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Copy_16x16.png">导出</button>
		    <button class="btn btn-small" onclick=""><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Save-16x16.png">保存</button>
		    <button class="btn btn-small" onclick="doDeploy()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Stock-Index-Up-16x16.png">发布</button>
		    <button class="btn btn-small" onclick="Gef.activeEditor.clear()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Cancel_16x16.png">清空</button>
		    <button class="btn btn-small" onclick="doUndo()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Undo_16x16.png">撤销</button>
		    <button class="btn btn-small" onclick="doRedo()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Redo_16x16.png">重做</button>
		    <button class="btn btn-small" onclick="doLayout()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Settings_16x16.png">布局</button>
		    <button class="btn btn-small" onclick=""><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/Delete_16x16.png">删除</button>
		    <button class="btn btn-small" onclick="alignVertical()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/New-16x16.png">竖直对齐</button>
		    <button class="btn btn-small" onclick="alignHorizontal()"><img src="${scopePrefix}/workflow/widgets/gef/images/visualpharm/New-16x16.png">水平对齐</button>
		  </div>
		</div>
	    <div id="__gef_palette__" style="float:left;">
		  <div style="border: 1px solid #CCCCCC; border-radius: 4px;padding: 2px;">
		    <div id="startnone" class="paletteItem-startnone" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="startnone-img" class="paletteItem-startnone" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/start-event.png" unselectable="on">
		    </div>
		    <div id="endnone" class="paletteItem-endnone" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="endnone-img" class="paletteItem-endnone" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/end-event.png" unselectable="on">
		    </div>
		    <div id="exclusive" class="paletteItem-exclusive" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="exclusive-img" class="paletteItem-exclusive" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/gateway.png" unselectable="on">
		    </div>
		    <div id="taskuser" class="paletteItem-taskuser" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="taskuser-img" class="paletteItem-taskuser" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/task.png" unselectable="on">
		    </div>
		    <div id="subprocess" class="paletteItem-subprocess" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="subprocess-img" class="paletteItem-subprocess" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/sub-process.png" unselectable="on">
		    </div>
		    <div id="pool" class="paletteItem-pool" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="pool-img" class="paletteItem-pool" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/pool.png" unselectable="on">
		    </div>
		    <div id="lane" class="paletteItem-lane" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="lane-img" class="paletteItem-lane" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/lane.png" unselectable="on">
		    </div>
		    <div id="catchtimer" class="paletteItem-catchtimer" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="catchtimer-img" class="paletteItem-catchtimer" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/catching-event.png" unselectable="on">
		    </div>
		    <div id="throwsignal" class="paletteItem-throwsignal" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="throwsignal-img" class="paletteItem-throwsignal" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/throwing-event.png" unselectable="on">
		    </div>
		    <div id="boundarycancel" class="paletteItem-boundarycancel" style="text-align:center;font-size:12px;cursor:pointer;" unselectable="on">
		      <img id="boundarycancel-img" class="paletteItem-boundarycancel" src="${scopePrefix}/workflow/widgets/gef/images/activities/32/boundary-event.png" unselectable="on">
		    </div>
		  </div>
	    </div>
