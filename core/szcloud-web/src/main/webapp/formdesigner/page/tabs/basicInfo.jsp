...
<div class="form-group">
	...
	<div class="col-md-4">
		<textarea name='readonlyScript' id='readonlyScript' rows='4' class='form-control'>${vo.readonlyScript}</textarea>
	</div>
	<label class="col-md-2 control-label">禁用脚本</label>
	<div class="col-md-4">
		<textarea name='disabledScript' id='disabledScript' rows='4' class='form-control'>${vo.disabledScript}</textarea>
	</div>
</div>	
<div class="form-group">
	<label class="col-md-1 control-label">隐藏脚本</label>
	<div class="col-md-4">
		<textarea name='hiddenScript' id='hiddenScript' rows='4' class='form-control'>${vo.hiddenScript}</textarea>
	</div>
...
<div class="form-group">
	...
	<div class="col-md-4">
		<textarea name='preLoadScript' id='preLoadScript' rows='4' class='form-control'>${vo.preLoadScript}</textarea>
	</div>
	<label class="col-md-2 control-label">加载后脚本</label>
	<div class="col-md-4">
		<textarea name='afterLoadScript' id='afterLoadScript' rows='4' class='form-control'>${vo.afterLoadScript}</textarea>
	</div>
</div>	
<div class="form-group">
