	...
	<body id="main">
		<div class="container-fluid">
			<div class="row" id="buttons">
				...
				<button type="button" class="btn btn-warning" id="checkOutBtn"><i class="icon-edit"></i>签出</button>
				<button type="button" class="btn btn-warning" id="checkInBtn"><i class="icon-edit"></i>签入</button>
				<button type="button" class="btn btn-info " id="relation"><i class="icon-zoom-out"></i>引用关系</button>
				<button type="button" class="btn btn-info " id="catTemplate"><i class="icon-zoom-out"></i>查看发布后内容</button>
				<button type="button" class="btn btn-info " id="sysKeyWords"><i class="icon-zoom-out"></i>系统关键字</button>
			...
			<form class="form-horizontal" id="groupForm" action="<%=basePath%>fd/save.do" method="post">
				...
				<div class="row tab-content">
					    ...
					    <%-- <!-- <c:if test="${ not empty vo.id }">
					    	<div class="tab-pane" id="comloytree"><jsp:include page="tabs/component-layout-list.jsp"/></div> 
					    </c:if> --> --%>
				</div>
			</form>
		</div>
