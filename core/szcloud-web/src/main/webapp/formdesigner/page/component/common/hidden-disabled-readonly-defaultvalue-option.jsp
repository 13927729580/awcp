...
<div class="form-group">
	...
	<label class="col-md-2"><a href="javascript:openCodeMirror('defaultValueScript');">option选项脚本(服务器脚本)</a></label>	
	<div class="col-md-4">
		<textarea name='optionScript' id='optionScript' rows='4' class='form-control'></textarea>
	</div>
</div>
<div class="form-group">
