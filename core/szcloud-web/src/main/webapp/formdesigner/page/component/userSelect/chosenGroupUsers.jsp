...
<html>
	...
	<body id="main" class="inner-form">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-3 col-xs-3">					
					<div class="panel tree-panel" style="height:394px;">
                  
					<div class="panel-heading departpanel" id="departTab" style="display:block; background:none;height:354px;">
					</div>
								...
								<div class="input-group" style="height: 30px;">
									<!-- 
										...
										<span class="input-group-btn"> 
											<button class="btn btn-default" type="button" id="subeq" onclick="subSearch()"><i class="icon-search"></i>筛选</button> 
										</span>
									 -->
		...
		<script type="text/javascript" src="<%=basePath%>resources/scripts/platform.selectGroupPanel.js"></script>
