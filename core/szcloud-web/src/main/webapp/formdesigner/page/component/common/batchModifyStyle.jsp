...
<body id="main">
	...
	<div class="container-fluid">
		<div class="row" id="buttons">
			<button type="button" class="btn btn-success" id="batchModifyStyle"><i class="icon-plus-sign"></i>保存</button>
...
<div class="form-group">
	...
	<script type="text/javascript">	
		...
		$('document').ready(function(){
			...
			$("#batchModifyStyle").click(function(){
				if($.formValidator.pageIsValid('1')){
					...
					$.ajax({
						type: "POST",
						url: basePath + "component/batchModifyStyle.do",
						data: "style="+encodeURI(style) +
