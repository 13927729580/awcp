    ...
    <form id="componentForm" action="">
        ...
        <div class="row tab-content">
            <div class="tab-pane active" id="tab1">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label required">地图高度(px)：</label>
                    <div class="col-md-4">
                        <input type="text" name='ibs_height' id='ibs_height'  class='form-control'/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label required">高德地图key值：</label>
                    <div class="col-md-4">
                        <input type="text" name='ibs_key' id='ibs_key'  class='form-control'/>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('document').ready(function(){
        ...
        $("#ibs_height").formValidator({onShow:"请输入序号",onFocus:"请输入地图高度",onCorrect:"合法"})
            .regexValidator({regExp:"intege1",dataType:"enum",onError:"正整数格式不正确"});
    });
