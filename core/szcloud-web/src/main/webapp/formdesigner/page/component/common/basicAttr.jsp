...
<div class="form-group">
	<label class="col-md-2 control-label required">显示文本(中文)</label>
	<div class="col-md-4">
		<input name="title" class="form-control" id="title" type="text" value="">
	</div>
</div>
<div class="form-group">
	<label class="col-md-2 control-label required">显示文本(英文)</label>
	<div class="col-md-4">
		<input name="enTitle" class="form-control" id="enTitle" type="text" value="">
	</div>
</div>
<div class="form-group">
	<label class="col-md-2 control-label required">是否必填(0：否,1：是)</label>
	<div class="col-md-4">
		<input name="required" class="form-control" id="required" type="text" value="0">
	</div>
</div>

<div class="form-group">
	<label class="col-md-2 control-label">提示文字</label>
	<div class="col-md-4">
		<input name="placeholder" class="form-control" id="placeholder" type="text">
	</div>
</div>
