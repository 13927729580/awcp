...
<div class="form-group">
	...
	<label class="col-md-2"><a href="javascript:openCodeMirror('defaultValueScript');">显示脚本(服务器脚本)</a></label>	
	<div class="col-md-4">
		<textarea name='showScript' id='showScript' rows='4' class='form-control'></textarea>
	</div>
</div>
