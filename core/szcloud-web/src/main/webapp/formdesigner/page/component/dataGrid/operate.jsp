...
<div class="form-group">
	...
	<div class="col-md-4">
			<label class="checkbox-inline"> <input name="operateAdd"
				type="checkbox" value="1"> 新增
			</label> <label class="checkbox-inline"> <input name="operateEdit"
				type="checkbox" value="1"> 编辑
			</label> <label class="checkbox-inline"> <input name="operateDelete"
...
<div class="form-group">
	...
	<div class="col-md-4">
		<select name="alertPage" class="form-control" id="alertPage" type="text" value="">
...
<div class="text-right">
	<button type="button" class="btn btn-info" id="addParament"><i class="icon-trash"></i>新增传参</button>
