...
<body id="main">
	...
	<div class="container-fluid">
		<div class="row" id="buttons">
			<button type="button" class="btn btn-success" id="batchModifyProportion"><i class="icon-plus-sign"></i>保存</button>
...
<div class="form-group">
	...
	<div class="col-md-4">
		<input name="proportion" class="form-control" id="proportion" type="text" value="">
	</div>
</div>
