...
<body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<div class="login_box">
					...
					<div class="login_form">
						<form action="<%=basePath%>login.do" id="loginForm" method="post">
							<input type="hidden" name="targetUrl" id="targetUrl" value="systemChoose.do"/>
							<ul>
								<li>
									<h1>云账号登录</h1>
								...
								<li><input type="password" id="userPwd" name="userPwd"
									title="密码至少6位" class="form-control w300" 
									value=""/></li>
								<li class="clearfix"><input type="text" id="verifyCode" name="verifyCode"
									title="5位校验码" class="form-control w160" value="验证码" placeholder="验证码"
									...
									style="float: left; padding-left: 18px; display: inline-block;">
										<a title="显示一组新字符" href="javascript:refreshVerifyCodeImage();">
								...
								<li class="clearfix"><span class="rem fl"><input type="checkbox"
										style="margin: 0">&nbsp;记住密码</span> <span class="forg fr"><a
										href="javascript:void(0)">忘记密码？</a></span></li>
								<li class="clearfix">
									<a href="javascript:void(0)" class="btn btn-success w120 h36" id="loginButton">登录</a> 
									<a href="javascript:void(0)" class="btn btn-primary w120 h36">注册</a></li>
							</ul>
						</form>
					</div>
				</div>
		...
		<tr class="szC-logoBar">
			<td align="left"><span class="fLink fw14"> <a
					href="javascript:void(0)">关于政务云</a> <a href="javascript:void(0)">客户服务</a>
					<a href="javascript:void(0)">隐私政策</a> <a href="javascript:void(0)">联系我们</a>
			</span></td>
	...
	<script language="javascript">
		function refreshVerifyCodeImage() {//图形验证码 
			document.getElementById("verifyCodeImage").src = "<%=basePath%>VerifyCodeServlet?now="+ new Date();
		}
		//change the frame of loginbox
		function FrameSet() { 
 			if($(window).width()<767){
