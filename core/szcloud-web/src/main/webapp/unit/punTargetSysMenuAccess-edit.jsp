...
<script src="<%=basePath %>resources/JqEdition/jquery-2.2.3.min.js" language="javascript" type="text/javascript"></script>
...
<div class="whole" style="margin:20px;">
	...
	<div class="C_btns">
		<a class="btn btn-info" href="<%=basePath%>/dev/punTargetRoleAccessList.do?currentPage=0">返回</a>
	</div>
</div>
<p>${menuJson}</p>
