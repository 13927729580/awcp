...
<html>
	<head>
		...
		<link title="default" rel="stylesheet" type="text/css" href="base/resources/content/styles/style.css" />
		<script src="<%=basePath %>resources/JqEdition/jquery-1.10.2.js" type="text/javascript"></script>
		<script src="<%=basePath%>base/resources/zui/dist/js/zui.js"  type="text/javascript"></script>
	...
	<body class="C_formBody">
        ...
        <form class="form-horizontal" id="submitForm" action="<%=basePath%>dev/punDevRoleAccessSave.do" method="post">
