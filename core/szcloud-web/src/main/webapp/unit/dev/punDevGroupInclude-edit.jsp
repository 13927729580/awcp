...
<%-- <title>${group.groupChName }组内用户</title> --%>
<title>组内用户</title>
		...
		<div class="container-fluid">
			...
			<div class="row" id="breadcrumb">
				<ul class="breadcrumb">
					...
					<li><a >首页</a></li>
					<li><a href= "<%=basePath%>dev/punDevGroupList.do?currentPage=0">组织机构与权限</a></li>
					<!-- <li><a >组信息编辑</a></li> -->
			...
			<div class="row" id="buttons">
				<a href="<%=basePath%>dev/punDevGroupList.do" class="btn" id="undoBtn">
			...
			<div class="row" id="searchform">
				<div id="collapseButton" class="collapse">
					<form action="<%=basePath%>dev/punDevGroupIncludeSearch.do" id="createForm">
			...
			$(function(){
				  ...
				  $("#addBtn").click(function(){
		      			top.dialog({ 
							...
							title: '添加用户到组',
							url:'<%=basePath%>dev/punDevGroupNotInclude.do?groupId=${group.id}',
							width : 800,
							height : 600,
							onclose: function () {
								//location.reload();
				  ...
				  $("#deleteBtn").click(function(){
					  if(count<1){
						...
						//ajax提交
						$.ajax({
							url : "<%=basePath%>dev/punDevGroupRemoveUser.do",
