		...
		<div class="container-fluid">
			...
			<div class="row" id="searchform">
				<div id="collapseButton" class="collapse">
					<form action="<%=basePath%>manage/manageGroupList.do" id="createForm" class="clearfix">
		...
		<script type="text/javascript">
		  $(function(){
      		...
      		$("#addBtn").click(function(){
      			var url = "<%=basePath%>manage/intoPunGroup.do";
      			location.href = url;
      			return false;
      		})
      		...
      		$("#updateBtn").click(function(){
      			if(count == 1){
      				$("#manuList").attr("action","<%=basePath%>manage/punGroupGet.do").submit();
      			}else{
      				alertMessage("请选择某个组织进行操作");
      			}
      			return false;
      		});
          	...
          	$("#deleteBtn").click(function(){
          		...
          		if(window.confirm("确定删除？")){
	          		$("#manuList").attr("action","<%=basePath%>manage/punGroupDelete.do").submit();
          		}
      			return false;
          	});
          ...
          //relate
          	$("#relateBtn").click(function(){
        		...
        		//	var selectedId;
          		...
          		//		selectedId = $(this).val();
          		//	});
				//	location.href="<%=basePath%>manage/manageGroupUserList.do?groupId="+selectedId;
        			$("#manuList").attr("action","<%=basePath%>manage/manageGroupUserList.do").submit();
        		}else{
        			alert("选择一项进行操作！");
        		}
        		return false;
