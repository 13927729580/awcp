...
public class AuthorityGroupServiceImpl implements AuthorityGroupService{
	...
	public PageList<AuthorityGroupVO> queryPagedResult(String queryStr,
		...
		PageList<AuthorityGroupVO> groups = queryChannel.queryPagedResult(
				AuthorityGroupVO.class, queryStr, params, currentPage, pageSize,
				sortString);
		...
		PageList<AuthorityGroupVO> vos = new PageList<AuthorityGroupVO>(tmp,
				groups.getPaginator());
		groups.clear();
		return vos;
	}
	...
	public PageList<AuthorityGroupVO> selectPagedByExample(BaseExample example,
		...
		PageList<AuthorityGroup> list = queryChannel.selectPagedByExample(
				AuthorityGroup.class, example, currentPage, pageSize, sortString);
		PageList<AuthorityGroupVO> vos = new PageList<AuthorityGroupVO>(
				list.getPaginator());
	...
	public boolean delete(String[] ids) {
		...
		try {
			for (String id : ids) {
				AuthorityGroup au = BeanUtils.getNewInstance(AuthorityGroup.get(id),
	...
	@Override
	public List<AuthorityGroupVO> queryResult(String queryStr,
			Map<String, Object> params) throws MRTException {
		
		List<AuthorityGroupVO> resources = queryChannel.queryResult(
				AuthorityGroupVO.class, queryStr, params);
