...
public interface MetaModelService {
	 ...
	 * 条件 @param currentPage 当前页 @param pageSize 每页数 @param sortString 排序字段 @return
	 * PageList<MetaModelVO> @throws
	 */
	 ...
	 * 参数 @param currentPage 当前页 @param pageSize 每页数 @param sortString 排序 @return
	 * PageList<StoreVO> @throws
	 */
