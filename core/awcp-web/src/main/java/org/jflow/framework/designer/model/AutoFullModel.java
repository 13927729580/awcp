...
//    }
    ...
    public void BindTop()
    {
        ...
        this.Left.append("<li><div><a href=\"MapExt.aspx?FK_MapData=" + this.getFK_MapData() + "&RefNo=" + this.getRefNo() + "\"><span class=\"nav\">帮助</span></a></div></li>");
    ...
    public void init()
    {
        ...
        if (StringHelper.isNullOrEmpty(this.getRefNo()))
        {
            ...
            for(MapAttr en:mattrs.convertMapAttrs(mattrs))
            {
...
//                    continue;
        ...
        for(MapDtl dtl:MapDtls.convertMapDtls(dtls))
        {
            ...
            int count = 0;
            for(MapAttr mattr1:MapAttrs.convertMapAttrs(mattrs1))
            {
