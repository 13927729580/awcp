...
public class GetTaskModel {
	...
	public void init() {
        ...
        for(Flow fl : Flows.convertFlows(fls)){
            ...
            this.Pub1.append(BaseModel.AddTD("<a href=\"javascript:WinOpen('"+basePath+"WF/track/ChartTrack.jsp?FK_Flow=" + fl.getNo() + "&DoType=Chart','sd');\"  >打开</a>"));
	...
	public void BindWorkList(){
        ...
        //String canDealNodes = "";
        int idx = 1;
        for(GetTask jc : GetTasks.convertGetTasks(jcs)){
        	  /* 判断我是否可以处理当前点数据？ */
