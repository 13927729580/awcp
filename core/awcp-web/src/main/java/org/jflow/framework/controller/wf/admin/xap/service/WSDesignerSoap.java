...
@WebService(targetNamespace = "http://www.observer.com/service", serviceName = "WSDesigner")
public interface WSDesignerSoap {
	...
	@WebResult(name = "result")
	public String GetFlowTrackJsonData(@WebParam(name = "fk_flow") String fk_flow,
			@WebParam(name = "workid") String workid);
	...
	// {
	// String path = FlowFileName[0], fileName = FlowFileName[1], fileType =
	// FlowFileName[2], cmd = FlowFileName[3];
	//
	...
	// }
	//
	// String ip = "online.ccflow.org", userNo = "ccflowlover", pass =
	// "ccflowlover";
