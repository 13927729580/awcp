...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	{
		this.Items.clear();
		for (EntityTree en : EntitiesTree.convertEntityTree(ens))
		{
...
//C# TO JAVA CONVERTER TODO TASK: Java has no equivalent to C#-style event wireups:
	...
	{
		for (XmlEn xml : XmlEns.convertXmlEns(xmls))
		{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	{
		this.Items.clear();
		for(Entity en : Entities.convertEntities(cateEns))
		{
			...
			this.Items.add(li);
			for(Entity suben : Entities.convertEntities(subEns))
			{
...
///#warning 这里出错误。
	...
	{
		this.Items.clear();
		for(EntityNoName en :EntitiesNoName.convertEntityNoName(ens))
		{
			ListItem li = new ListItem();
			if (isShowKey)
			{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	{
		this.Items.clear();
		for(EntityOIDName en : EntitiesOIDName.convertEntitiesOIDName(ens))
		{
