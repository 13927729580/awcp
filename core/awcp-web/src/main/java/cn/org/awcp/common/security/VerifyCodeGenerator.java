...
public class VerifyCodeGenerator {
	...
	private BufferedImage getImage(String verifyCode) {
		...
		createBackground(graphics, WIDTH * 8, HEIGHT); // 画背景
		drawCharacter(graphics, verifyCode); // 画字符串
	...
	public Map<String, BufferedImage> printImage() {
		String verifyCode = this.getRandString(); // 获得随机验证码
		BufferedImage bi = this.getImage(verifyCode); // 获得验证码的图像数据
