...
public class TranslateUtil {
	 ...
	 * 日志对象
	 */
	private static final Log logger = LogFactory.getLog(TranslateUtil.class);
	...
	public static String translate(String q, String from, String to) throws Exception {
		...
		try {
			...
			if (error_code != null) {
				logger.debug("出错代码:" + error_code);
				logger.debug("出错信息:" + resultJson.getString("error_msg"));
				return null;
			}
		} catch (Exception e) {
		}
