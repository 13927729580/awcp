...
public class PageActController extends BaseController {
	...
	public String getWorkflowByPageId(String id) {
	...
	public List<PageActVO> getByAjaxAndPageId(@RequestParam(value = "dynamicPageId", required = false) String id) {
	...
	private boolean validate(ModelAndView mv, PageActVO vo) {
		...
		if (StringUtils.isEmpty(vo.getDynamicPageId())) {
