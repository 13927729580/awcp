...
public class FormDesignGlobal {
	...
	static {
		...
		// COMPOENT_TYPE_NAME.put("1029", "单人选择框");// 计算值、隐藏、禁用
		// COMPOENT_TYPE_NAME.put("1030", "下级用户选择框");// 计算值、隐藏、禁用
		// COMPOENT_TYPE_NAME.put("1031", "sql用户选择框");// 计算值、隐藏、禁用
		...
		// COMPOENT_TYPE_NAME.put("1101", "钉钉文本输入框");
		// COMPOENT_TYPE_NAME.put("1102", "钉钉时间选择框");
		// COMPOENT_TYPE_NAME.put("1103", "钉钉多行输入框");
		// COMPOENT_TYPE_NAME.put("1104", "钉钉图片选择框");
		...
		// COMPOENT_TYPE_URL.put("1007",
		// "formdesigner/page/component/password/password.jsp");
		...
		// COMPOENT_TYPE_URL.put("1013",
		// "formdesigner/page/component/searchComponent/searchComponent.jsp");
		// COMPOENT_TYPE_URL.put("1014",
		// "formdesigner/page/component/span/span.jsp");
		// COMPOENT_TYPE_URL.put("1015",
		// "formdesigner/page/component/tips/tips.jsp");
		...
		// COMPOENT_TYPE_URL.put("1018",
		// "formdesigner/page/component/pureText/pureText.jsp");
		...
		// COMPOENT_TYPE_URL.put("1026",
		// "formdesigner/page/component/dynamicSelect/dynamicSelect.jsp");
		// COMPOENT_TYPE_URL.put("1025",
		// "formdesigner/page/component/tabs/tabs.jsp");
		// COMPOENT_TYPE_URL.put("1027",
		// "formdesigner/page/component/zTree/zTree.jsp");
		// COMPOENT_TYPE_URL.put("1028",
		// "formdesigner/page/component/roleSelect/roleSelect.jsp");
		// COMPOENT_TYPE_URL.put("1029",
		// "formdesigner/page/component/userSelect/userSelect.jsp");
		// COMPOENT_TYPE_URL.put("1030",
		// "formdesigner/page/component/userSelect/userSelect.jsp");
		// COMPOENT_TYPE_URL.put("1031",
		// "formdesigner/page/component/userSelect/userSelect.jsp");
		...
		// COMPOENT_TYPE_URL.put("1035",
		// "formdesigner/page/component/aMap/amap.jsp");
		...
		// COMPOENT_TYPE_URL.put("1038",
		// "formdesigner/page/component/gridTable/table.jsp");
		...
		// COMPOENT_TYPE_URL.put("1101",
		// "formdesigner/page/component/dingding/input/input.jsp");
		// COMPOENT_TYPE_URL.put("1102",
		// "formdesigner/page/component/dingding/datetime/datetime.jsp");
		// COMPOENT_TYPE_URL.put("1103",
		// "formdesigner/page/component/dingding/textarea/textarea.jsp");
		// COMPOENT_TYPE_URL.put("1104",
		// "formdesigner/page/component/dingding/image/image.jsp");
