...
import cn.org.awcp.formdesigner.application.vo.CompareValidatorVO;
import cn.org.awcp.formdesigner.application.vo.CustomValidatorVO;
import cn.org.awcp.formdesigner.application.vo.InputValidatorVO;
import cn.org.awcp.formdesigner.application.vo.RegexValidatorVO;
...
public class ValidatorController extends BaseController {
	...
	/**
	 * 跳转到编辑页面，编辑校验信息 1.点击某个校验进行编辑 2.保存时校验失败，跳转到编辑页面，带有错误信息
	 * 
	 * @param id
	 * @return
	 */
