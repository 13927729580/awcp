...
function SetSelected(cb, ids) {
	...
	function BPToolBar1_ButtonClick()
	{
		...
		$.ajax({
				cache: false,
				type: "POST",
				url:"<%=basePath%>WF/MapDef/getStr.do?btnId="+ btnId + "&DDL_Group=" + DDL_Group + "&EnName="+ EnName + "&PK=" + PK + "&AttrKey=" + AttrKey, //把表单数据发送到ajax.jsp
...
<body class="easyui-layout" onload="load()">
	...
	<form method="post" action="" id="form1" onsubmit="return BPToolBar1_ButtonClick()">
