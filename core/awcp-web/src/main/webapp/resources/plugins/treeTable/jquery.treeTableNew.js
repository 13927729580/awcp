...
(function ($) {
    ...
    if (document.location.href.indexOf('http://') != 0)    {
        var path = '../awcp/resources/plugins/treeTable/';
    } else {
        var path = SITE_URL + '/awcp/resources/plugins/treeTable/';
    ...
    $.fn.treeTable = function (opts) {
        ...
        /*if ($('head').find('#tree_table_' + opts.theme).length == 0) {
           // $('head').append('<link id="tree_table_' + opts.theme + '" href="' + path + opts.theme + '/jquery.treeTableNew.css" rel="stylesheet" type="text/css" />');
        }*/
		//alert(path + opts.theme + '/jquery.treeTable.css');
