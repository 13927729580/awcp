...
$.formValidator = 
{
	...
	{
		//当前是否有ajax校验正在进行，如果是，则提示，否则直接进行校验
	...
	setTipState : function(elem,showclass,showmsg)
	{
		...
		else
		{
			...
			else
			{
				...
				jqobj.poshytip('update', showmsg);
				//jqobj.poshytip('hideDelayed', 2000);
				var stype = elem.type;
    ...
    getLength : function(id)
    {
		...
		//alert("id:" + elem.id + " # " + elem.options.selectedIndex);
        var sType = elem.type;
        var len = 0;
        switch(sType)
		{
	...
	regexValid : function(returnObj)
	{
		...
		else 
		{
			...
			$.each(regexArray, function() {
			    ...
			    //alert("setting.param " + setting.param);
		...
		if(initConfig.autoTip)
		{
			...
			{				
				...
				{		
					...
					var formValidateTip = $("<div class=\"help-block alert alert-danger\" style=\"float: left; position: absolute; z-index: 53; border:#f00 0px dotted; \" id='"+tip+"'></div>").appendTo($("body"));
...
{
	validatorGroup : "1",
	//onShow :"Please input the content",
	//onFocus: "Please input the content",
	onCorrect: "Enter correct",
...
var regexValidator_setting = 
{
	...
	dataType : "string",
	compareType : "||",
	onError:"The input format is not correct",
