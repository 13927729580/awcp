	...
	<div class="container-fluid">
		...
		<div class="row" id="dataform">
			<form class="form-horizontal" id="actForm"
				...
				<div class="form-group ">
					...
					<div class='col-md-5'>
						<select class=" form-control" name="actType" 
							id="actType" disabled="disabled">
							<option value="2000" selected="selected">普通</option>
						</select>
					</div>
				</div>
				<!--<div class="form-group">
				...
				<div class="col-md-11">
					<textarea name='serverScript' id='serverScript' rows='12'
			...
			<label class="col-md-1 control-label">客户端脚本</label>
				<div class="col-md-11">
					<textarea name='clientScript' id='clientScript' rows='12'
