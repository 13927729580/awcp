...
<div class="page-header tab-pane " style="dispaly:none" id="hiddenConfig" >
	<div class="form-group">
		...
		<div class="col-md-5">
			<textarea name='hiddenScript' id='hiddenScript' rows='4' class='form-control'>${act.hiddenScript }</textarea>
		</div>
	</div>
	<div class="form-group">
		<label class="col-md-1 control-label">服务端脚本</label>
		<div class="col-md-5">
			<textarea name='serverScript' id='serverScript' rows='10' class='form-control'>${act.serverScript }</textarea>
		</div>
		<label class="col-md-1 control-label">客户端脚本</label>
		<!-- <label class="checkbox-inline"> <input id="ajaxExcute" name="ajaxExcute" type="checkbox" value="1"/>ajax执行</label>  
		<label class="checkbox-inline"> <input id="ajaxView" name="ajaxView" type="checkbox" value="1"/>ajax弹框</label> -->  
		<div class="col-md-5">
			<textarea name='clientScript' id='clientScript' rows='10' class='form-control'>${act.clientScript }</textarea>
		</div>
	</div>
	<div class="form-group">
		<label class="col-md-1 control-label">描述</label>
		<div class="col-md-11">
			<textarea name='description' id='description' rows='4' class='form-control'>${act.description }</textarea>
		</div>
