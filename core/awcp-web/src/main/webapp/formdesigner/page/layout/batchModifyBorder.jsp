...
<body id="main">
	...
	<div class="container-fluid">
		<div class="row" id="buttons">
			<button type="button" class="btn btn-success" id="batchModifyBorder"><i class="icon-plus-sign"></i>保存</button>
	...
	<script type="text/javascript">	
		...
		$('document').ready(function(){
			...
			$("#batchModifyBorder").click(function(){
				if($.formValidator.pageIsValid('1')){
					...
					$.ajax({
						type: "POST",
						url: basePath + "layout/batchModifyBorder.do",
						data: "textstyle="+textstyle + "&_selects="+_selects+"&dynamicPageId=" + dynamicPageId,
						async : false,
