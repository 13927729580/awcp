			...
			<div class="row" id="dataform">
				<form class="form-horizontal" id="styleForm" action="<%=basePath%>fd/style/save.do" method="post" >
					...
					<div class="form-group">       	
			            <label class="col-md-2 control-label required">样式名称：</label>
			            <div class="col-md-4">
			                <input name="name" class="form-control" id="name" type="text" value="${vo.name}">
			            </div>
			             <label class="col-md-2 control-label required">样式描述：</label>
			            <div class="col-md-4">
			                <input name="description" class="form-control" id="description" type="text" value="${vo.description}">
			            </div> 
			 	    </div>
					<div class="form-group">       	
			            <label class="col-md-2 control-label required">样式脚本：</label>
			            <div class="col-md-10">
					...
					<div class="form-group"><!-- 表单提交按钮区域 -->
           			 	<div class="col-md-offset-2 col-md-10">
              				...
              				<button class="btn" id="undoBtn"><i class="icon-undo"></i>取消</button>
            			</div>
       				</div>
				</form>
			</div>
         	...
         	$(document).ready(function(){
			    ...
			    $("#undoBtn").click(function(){
			    	if(dialog){
			    		...
			    		location.href = "<%=basePath%>fd/style/list.do?currentPage=1";
			    	}
			    	return false;
			    });
