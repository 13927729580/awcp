		...
		<div class="container-fluid">
			<div class="row" id="breadcrumb">
				<ul class="breadcrumb">
		          ...
		          <li class="active">则正校验编辑</li>
		        </ul>
			</div>
			
			<div class="row" id="dataform">
				<form class="form-horizontal"  id="actForm"  action="<%=basePath%>fd/validator/saveRegexValidator.do" method="post" >
					...
					<div class="form-group">
							...
							<div class="col-md-4">
								<textarea name="regExp" class="form-control" id="regExp" rows="4">${vo.regExp}</textarea>
							</div>
				   </div>
					<div class="form-group">
