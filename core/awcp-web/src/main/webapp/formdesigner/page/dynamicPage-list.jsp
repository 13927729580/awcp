...
<body id="main">
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$(".table-datatable").find("tbody").find("tr").eq(0).find("td").eq(2).css("width","35%");
			$(".table-datatable").find("thead").find("th").eq(3).css("width","25%");
			$(".table-datatable").find("tbody").find("tr").eq(0).find("td").eq(3).css("width","25%");
