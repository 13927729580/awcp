	...
	<div class="container-fluid">
		...
		<form id="componentForm" action="">
			...
			<div class="row tab-content">
				<div class="tab-pane active" id="tab1"><%@ include file="/formdesigner/page/component/zTree/basicInfo.jsp" %></div>
				...
				<div class="tab-pane " id="tab4"><%@ include file="/formdesigner/page/component/zTree/selectColumns.jsp" %></div>
			</div>
		</form>
	</div>
