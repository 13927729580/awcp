		...
		<form id="componentForm" action="">
			...
			<div class="row tab-content">
				<div class="tab-pane active" id="tab1">
					...
					<div class="form-group">
						<label class="col-md-2 control-label">表格类型</label>
						<div class="col-md-4">
							<select name='gridType' id='gridType' class='form-control'">
							  <option value="easyui-datagrid">基本表格</option>
							  <option value="easyui-treegrid">树形表格</option>
							</select>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">数据源API：</label>
						<div class="col-md-4">
							<textarea name='dataSource' id='dataSource' class='form-control'></textarea>
						</div>
					</div>
					
					
					<div class="form-group">
						<label class="col-md-2 control-label">表格配置：</label>
						<div class="col-md-4">
							<textarea name='tableConf' id='tableConf' class='form-control' value="method: 'post',rownumbers: true,idField: 'id',treeField: 'name'"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">单元格配置：</label>
						<div class="col-md-4">
							<textarea name='gridConf' id='gridConf' class='form-control' value="method: 'post',rownumbers: true,idField: 'id',treeField: 'name'"></textarea>
						</div>
					</div>
				</div>
			</div>
