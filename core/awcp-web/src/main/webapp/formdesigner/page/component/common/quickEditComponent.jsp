...
<body id="main">
	<div class="container-fluid">
		<div class="row" id="buttons">
			<button type="button" class="btn btn-success" id="saveQuickComponent"><i class="icon-plus-sign"></i>保存</button>
		...
		<form id="componentForm" action="">
			...
			<div class="row tab-content">
				<div class="tab-pane " id="tab1"><%@ include file="/formdesigner/page/component/common/basicInfo.jsp" %></div>
		...
		$('document').ready(function(){
			...
			$("#name").formValidator({onFocus:"至少1位,最多32位",onCorrect:"符合要求"})
