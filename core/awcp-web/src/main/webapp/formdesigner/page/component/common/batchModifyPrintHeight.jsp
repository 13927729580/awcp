...
<body id="main">
	...
	<div class="container-fluid">
		<div class="row" id="buttons">
			<button type="button" class="btn btn-success" id="batchModifyPrintHeight"><i class="icon-plus-sign"></i>保存</button>
...
<div class="form-group">
	<label class="col-md-2 control-label ">行高类型</label>
	<div class="col-md-4">
...
<div class="form-group">
	<label class="col-md-2 control-label ">行高</label>
	<div class="col-md-4">
		<input name="height" class="form-control" id="height" type="text" value="">
	</div>
</div>
	...
	<script type="text/javascript">	
		...
		$('document').ready(function(){
			...
			$("#batchModifyPrintHeight").click(function(){
				if($.formValidator.pageIsValid('1')){
					...
					$.ajax({
						type: "POST",
						url: basePath + "component/batchModifyPrintHeight.do",
						data: "heightType="+heightType + "&height="+height +
