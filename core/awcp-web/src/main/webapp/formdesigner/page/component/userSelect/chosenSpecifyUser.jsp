...
<html>
	...
	<body id="main" class="inner-form">
			...
			<div class="row">								
                <div class="col-md-12 col-xs-12">
                	<div class="row checkbar">
						<!--
                		<div class="col-md-4  col-xs-4  text-left"><span class="btn btn-default" id="toMessage"><i class="icon-check-empty"></i> 短信通知</span></div>
                		<div class="col-md-4  col-xs-4  text-left"><span class="btn btn-default" id="toOnline"><i class="icon-check-empty"></i> 转在办</span></div>
						-->
		...
		<script type="text/javascript" src="<%=basePath%>resources/scripts/platform.specifySelectPanel.js"></script>
      ...
      try {
		   ...
		   $("#subBtn").click(function(){//关闭弹窗 提交
			   ...
			   $.ajax({
					type: "GET",
					url: "<%=basePath%>workflow/wf/specifyReceive.do?WorkID="+Request["WorkID"]+"&NodeID="+Request["NodeID"]+"&FK_Flow="+Request["FK_Flow"]+"&userIds="+membersID,
					data:"",
					datatype:"json",
					async : false,
