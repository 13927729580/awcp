		...
		<form id="componentForm" action="">
			...
			<div class="row tab-content">
				<div class="tab-pane active" id="tab1">
					...
					<div class="form-group">
						<label class="col-md-2 control-label">父数据源API：</label>
						<div class="col-md-4">
							<textarea type='text' name='dataSource' id='dataSource' class='form-control'></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">子数据源API：</label>
						<div class="col-md-4">
							<textarea type='text' name='sonDataSource' id='sonDataSource' class='form-control'></textarea>
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-md-2 control-label">父表格配置：</label>
						<div class="col-md-4">
							<textarea name='gridConf' id='gridConf' class='form-control'></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">表格高度：</label>
						<div class="col-md-4">
							<input name='gridHeight' id='gridHeight' class='form-control'/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">父单元格配置：</label>
						<div class="col-md-4">
							<textarea name='gridCellConf' id='gridCellConf' class='form-control' ></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">子表格配置：</label>
						<div class="col-md-4">
							<textarea name='sonGridConf' id='sonGridConf' class='form-control' ></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">子单元格配置：</label>
						<div class="col-md-4">
							<textarea name=sonGridCellConf id='sonGridCellConf' class='form-control'></textarea>
						</div>
					</div>
				</div>
			</div>
