	...
	<body id="main" class="inner-form">
				...
				<div class="col-md-3 col-xs-3">
					...
					<div class="panel tree-panel" style="width:270px">
						...
						<div class="input-group">
							...
							<span class="input-group-btn"> <button class="btn btn-default" type="button" id="subeq" onclick="subSearch()"><i class="icon-search"></i>Search</button> 
							</span>
                        </div>
						</form>
						-->
			            ...
			            <div class="panel-heading grouppanel" id="groupTab" style="display:none; background:none;height:0px;">
			            		<ul class="nav nav-tabss clearfix" id="myGroupTab">
     								<li  class="active"><a href="#tab1" data-toggle="tab" onClick="searchDefineGroup()">Custom Group</a></li>		
							     </ul>
			            </div>
			            -->
		...
		var groupId = ${sessionScope.current_user.groupId};
         ...
         $(function(){
        	...
        	$("#search").css("padding-top","3px").css("padding-bottom","3px");
