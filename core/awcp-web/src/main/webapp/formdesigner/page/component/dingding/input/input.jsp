	...
	<div class="container-fluid">
		...
		<form id="componentForm" action="">
			...
			<div class="row tab-content">
				<div class="tab-pane active" id="tab1"><%@ include file="/formdesigner/page/component/dingding/input/basicInfo.jsp" %></div>
	...
	<script type="text/javascript">	
		...
		$('document').ready(function(){
			...
			$("#layoutId").formValidator({
				...
				min:1,
				empty:{leftEmpty:false,rightEmpty:false},onError:"请选择布局"
			});
