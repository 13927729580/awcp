			...
			<div class="row tab-content">
				<div class="tab-pane active" id="tab1">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" name='selectLabel' id='selectLabel'  class='form-control' placeholder="名称@ID"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">下拉框name值：</label>
						<div class="col-md-4">
							<input type="text" name='selectName' id='selectName'  class='form-control' placeholder="name@id"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">文本标签值：</label>
						<div class="col-md-4">
							<input type="text" name='textLabel' id='textLabel'  class='form-control' placeholder="角色@组织"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">文本name值：</label>
						<div class="col-md-4">
							<input type="text" name='textName' id='textName'  class='form-control' placeholder="role@group"/>
							<input type="hidden" name='searchLocation' id='searchLocation' value="1"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">日期选择标签值：</label>
						<div class="col-md-4">
							<input type="text" name='dateSelectLabel' id='dateSelectLabel' class='form-control' placeholder="开始日期@结束日期"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">日期选择name值：</label>
						<div class="col-md-4">
							<input type="text" name='dateSelectName' id='dateSelectName' class='form-control' placeholder="beginDate@endDate"/>
						</div>
					</div>				
				</div>
