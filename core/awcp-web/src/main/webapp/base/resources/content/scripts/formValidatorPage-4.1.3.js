    ...
    $.formValidator =
{
    ...
    oneIsValid: function (id) {
        ...
        if ($("#" + id).is(":visible") == false) { return true; } //add by longjs
        var e = {};
        e.id = id;
        e.dom = $("#" + id).get(0);
    ...
    pageIsValid: function (validatorGroup) {
        ...
        $.each(initConfig.validObjects, function () {
            ...
            if ($(this).is(":hidden")) { return true; } //add by longjs
    ...
    ajaxValid: function (e) {
        ...
        if (document.getElementById("MyUserType") != null)
            ls_url = ls_url + "&UserType=" + document.getElementById("MyUserType").value; //add by longjs
        //alert(ls_url);
        //发送ajax请求
        $.ajax(
		{
    ...
    $.fn.formValidator = function (cs) {
        ...
        return this.each(function (e) {
            ...
            //初始化显示信息longjs find 不注释掉就无法输入中文
//            if (initConfig.mode != "AlertTip") {
...
var passwordValidator_setting = {
	...
	onErrorContinueChar:"密码字符不允许为连续字符。",
	onErrorSameChar:"密码字符不允许为相同字符。",
	onErrorCompareSame:"密码不能与用户名相同。"
};
