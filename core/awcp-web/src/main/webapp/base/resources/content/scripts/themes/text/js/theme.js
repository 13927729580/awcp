...
var onShowClass = "";
var onFocusClass = "";
var onErrorClass = "ipt-err";
var onCorrectClass = "ipt";
//固定提示层的HTML
...
'<P id=passStrong class="pswState">强度：<B class="progressImage prog0"></B></P>',
'<P id=passStrong class="pswState">强度：<B class="progressImage prog1"></B></P>',
'<P id=passStrong class="pswState">强度：<B class="progressImage prog2"></B></P>',
'<P id=passStrong class="pswState">强度：<B class="progressImage prog3"></B></P>'
							  ];

var passwordStrengthText = ['密码强度：低', '密码强度：中', '密码强度：高']
