    ...
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
     \
      <td height="44" style="background-color:' + this.BackGround + ';"><div style="float: left; height:20px;line-height:20px; font-size:15px;  color:#000;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);"   style=" position: relative; cursor: pointer; float: right; height: 20px; width: 28px; color:#000; ' + (this.ShowCloseButton ? "" : "display:none;") + '"><span style="font-size:15px;">&times;</span></div></td>\
      \
    </tr>\
    <tr valign="top">\
      \
