$(function() {
  var springfox = {
    ...
    "securityConfig": function(cb) {
      $.getJSON(this.baseUrl() + "/api/configuration/security", function(data) {
        cb(data);
      });
    },
    "uiConfig": function(cb) {
      $.getJSON(this.baseUrl() + "/api/configuration/ui", function(data) {
        cb(data);
      });
    }
  };
  ...
  function initializeBaseUrl() {
    ...
    $.getJSON(relativeLocation + "/api/swagger-resources", function(data) {

      var $urlDropdown = $('#select_baseUrl');
      $urlDropdown.empty();
      $.each(data, function(i, resource) {
        var option = $('<option></option>')
            .attr("value", maybePrefix("/api"+resource.location, relativeLocation))
            .text(resource.name + " (/api"+ resource.location + ")");
