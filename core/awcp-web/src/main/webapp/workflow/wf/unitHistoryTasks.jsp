		...
		<div class="container-fluid">
			...
			<div class="row" id="searchform">
				<div id="collapseButton">
					<form action="<%=basePath%>workflow/wf/unitHistoryTasks.do" id="createForm" class="clearfix">
			...
			<div class="row" id="datatable">
				<form  action="<%=basePath%>/workflow/wf/unitHistoryTasks.do"  method="post" id="menuList">	
				...
				<table class="table datatable table-bordered">
					...
					<c:forEach items="${models}" var="item">
						<tr>
							...
							<td><a href="<%=basePath%>workflow/wf/openTask.do?WorkItemID=${item.WorkItemID}&EntryID=${item.EntryID}&flowTaskType=2&workType=2" >${item.WorkItemName}</a></td>
		  ...
		  $(function(){
			...
			if(message != null && message != ''){
      		...
      		$("#statusBtn").click(function(){
      			...
      			$("#menuList").attr("action","<%=basePath%>/workflow/wf/unitTaskStatus.do?taskType=2").submit();
      			return false;
      		});
