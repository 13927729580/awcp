...
<html lang="en">
  ...
  <head>
    ...
    <script type="text/javascript" src="${scopePrefix}/workflow/widgets/xform/xform-all.js"></script>
    <script type="text/javascript" src="${scopePrefix}/workflow/widgets/xform/adaptor.js"></script>
  </head>
			...
			<div class="tab-pane active" id="operation">
			  <div>
				<div class="xf-pallete" title="label">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_label.png">
				  label
				</div>
				<div class="xf-pallete" title="textfield">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_input.png">
				  textfield
				</div>
				<div class="xf-pallete" title="password">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_secret.png">
				  password
				</div>
				<div class="xf-pallete" title="textarea">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_textarea.png">
				  textarea
				</div>
				<div class="xf-pallete" title="select">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_select.png">
				  select
				</div>
				<div class="xf-pallete" title="radio">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_item.png">
				  radio
				</div>
				<div class="xf-pallete" title="checkbox">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_itemset.png">
				  checkbox
				</div>
				<div class="xf-pallete" title="fileupload">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_upload.png">
				  fileupload
				</div>
				<div class="xf-pallete" title="datepicker">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/new_range.png">
				  datepicker
				</div>
				<div class="xf-pallete" title="userpicker">
				  <img src="${scopePrefix}/workflow/widgets/xform/images/xform/userpicker.png">
				  userpicker
				</div>
			  </div>
			</div>
