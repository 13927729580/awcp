	...
	<body id="main">
		<div class="container-fluid">
			...
			<div class="row" id="buttons">
				...
				<button type="button" class="btn btn-info" id="viewProcessBtn"><i class="icon-trash"></i>查看流程</button>
			...
			<!--<div class="row" id="searchform">
				<div id="collapseButton" class="collapse">
					<form action="bpm-category-list.do" id="createForm" class="clearfix">
			...
			<div class="row" id="datatable">
				<form  method="post" id="createForm" action="bpm-category-list.do">	
				...
				<table class="table datatable table-bordered">
					...
					<c:forEach items="${models}" var="vo" varStatus="status">
						<tr>
							<td class="hidden formData"><input id="cateId" type="hidden"
		...
		<script type="text/javascript">
		  $(function(){
			  ...
			  $('table.datatable').datatable({
				  ...
				  checksChanged:function(event){
					  this.$table.find("tbody tr").find("input#cateId").removeAttr("name");
					  var checkArray = event.checks.checks;
					  count = checkArray.length;//checkbox checked数量
					  for(var i=0;i<count;i++){//给隐藏数据机上name属性
						  this.$table.find("tbody tr").eq(checkArray[i]).find("input#cateId").attr("name","cateId");
					  }
				  }
      		...
      		$("#editBtn").click(function(){
      			if(count == 1){
      				$("#createForm").attr("action","bpm-category-input.do").submit();
      			}else{
      		...
      		$("#exportBtn").click(function(){
      			if(count > 0){
      				$("#createForm").attr("action","bpm-category-export.do").submit();
      			}else{
      				alertMessage("请选择某个资源进行操作");
      			}
      			return false;
      	...
      	//viewProcess 查看流程
      		$("#viewProcessBtn").click(function(){
      			if(count > 0){
      				$("#createForm").attr("action","bpm-viewProcess.do").submit();
      			}else{
      				alertMessage("请选择某个资源进行操作");
      			}
      			return false;
          	...
          	$("#deleteBtn").click(function(){
          		...
          		if(window.confirm("确定删除？")){
	          		$("#createForm").attr("action","bpm-category-remove.do").submit();
          		}
      			return false;
          	});
