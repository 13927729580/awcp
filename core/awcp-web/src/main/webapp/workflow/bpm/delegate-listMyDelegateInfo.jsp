	...
	<body id="main">
		<div class="container-fluid">
			...
			<div class="row" id="buttons">
				...
				<button type="button" class="btn btn-info" id="deleteBtn"><i class="icon-trash"></i>禁用</button>
				<button type="button" class="btn btn-info" id="historyBtn"><i class="icon-trash"></i>历史</button>
			</div>
		...
		<script type="text/javascript">
		  $(function(){
      		...
      		$("#addBtn").click(function(){
      			var url = "delegate-prepareAutoDelegate.do";
      			location.href = url;
      			return false;
      		})
          	//delete
          	$("#deleteBtn").click(function(){
          		...
          		if(window.confirm("确定删除？")){
	          		$("#createForm").attr("action","delegate-removeDelegateInfo.do").submit();
          		}
      			return false;
          	});
          	...
          	$("#historyBtn").click(function(){
          		$("#createForm").attr("action","delegate-listDelegateHistories.do").submit();
      			return false;
          	});
          });
		</script>
