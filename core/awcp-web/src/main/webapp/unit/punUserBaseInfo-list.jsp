...
<body>
    ...
    <section class="content">
    	<div class="opeBtnGrop">
			...
			<a href="#" id="submitBtn" class="btn btn-primary">搜索</a>
			<a href="#" id="resetBtn" class="btn btn-info">清空</a>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-body">
						<form method="post" id="userList" action="<%=basePath%>unit/punUserBaseInfoList.do">
