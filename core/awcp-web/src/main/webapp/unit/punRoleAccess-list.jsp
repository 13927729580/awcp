		...
		<script type="text/javascript">
		  $(function(){
      		...
      		$("#addBtn").click(function(){
      			var url = "<%=basePath%>unit/intoPunRoleAccess.do";
      			location.href = url;
      			return false;
      		})
      		...
      		$("#updateBtn").click(function(){
      			...
      			if(count == 1){
      				$("#userList").attr("action","<%=basePath%>unit/punRoleAccessGet.do").submit();
      			}else{
      				alert("请选择一项进行操作");
      			}
      			return false;
          	...
          	$("#deleteBtn").click(function(){
          		if(window.confirm("确定删除？")){
	          		$("#userList").attr("action","<%=basePath%>unit/punRoleAccessDelete.do").submit();
          		}
      			return false;
          	});
          	//updata Access
          	$("#accessBtn").click(function(){
      			...
      			if(count == 1){
      				<%-- $("#userList").attr("action","<%=basePath%>unit/punSysMenuAccessEdit.do").submit(); --%>
      				var roleId =checkedDom.val();
      				//alert(roleId);
      				window.location.href="<%=basePath%>unit/punSysMenuAccessEdit.do?roleId="+roleId;
      			}else{
      				alert("请选择一项进行操作");
      			}
      			return false;
                  ...
                  <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                        <li>
                          ...
                          <form class="hide" action="unit/punRoleAccessList.do" id="createForm">
                          	<div style="margin-bottom: 10px;">
                             <span class="CItem">角色ID：</span>
                             <input name="currentPage" type="hidden" value="0"/>
                             <input name="roleId" value="${vo.roleId}" class="form-control" id="roleId" type="text" style="width: 360px;margin-bottom: 10px;" ></input>
                            </div>
	     ...
	     <form method="post" id="userList">
	        ...
	        <thead>   						
	          ...
	          <tr class="text-center">
	            ...
	            <th width="30%" class="text-center"><div class="header"><a href="javascript:void(0)">角色</a></div></th>
				<th width="30%" class="text-center"><div class="header"><a href="javascript:void(0)">资源</a></div></th>
				<th width="30%" class="text-center"><div class="header"><a href="javascript:void(0)">操作类型</a></div></th>
	          </tr>
	        </thead>
	        <tbody>
