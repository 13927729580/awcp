...
<body id="main">
		<div class="container-fluid">
			...
			<form class="form-horizontal" id="userForm"
				action="<%=basePath%>manage/updateSelfInfo.do" method="post">
	...
	$("#userName").formValidator({onShow:"请输入用户名",onFocus:"至少1位",onCorrect:"符合要求"}).inputValidator({min:1,empty:{leftEmpty:false,rightEmpty:false,emptyError:"不能有空符号"},onError:"必填"});
	...
	$("#saveBtn").click(function(){
		if(!$.formValidator.pageIsValid('1')){
		 ...
		 $.ajax( {  
             type : "POST",  
             url : "<%=basePath%>manage/updateSelfInfo.do",  
