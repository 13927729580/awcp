		...
		<div class="container-fluid">
			...
			<div class="row" id="searchform">
				<div id="collapseButton" class="collapse">
					<form action="<%=basePath%>manage/pdataDictionaryList.do" id="createForm" class="clearfix">
						...
						<div class="col-md-3">
							...
							<div class="input-group">
								<span class="input-group-addon">数据键</span>
								<input name="dataKey" class="form-control" id="dataKey" type="text" value="${vo.dataKey}"/>
							</div>
						...
						<div class="col-md-3">
							<div class="input-group">
								...
								<input name="dataValue" class="form-control" id="dataValue" type="text" value="${vo.dataValue}"/>
							</div>
							<!-- <div class="input-group">
								<span class="input-group-addon">数据顺序</span>
								<input name="dataOrder" class="form-control" id="dataOrder" type="text"/>
							</div> -->
						</div>
				...
				<table class="table datatable table-bordered">
					...
					<c:forEach items="${vos}" var="vo">
						<tr>
							...
							<td>${vo.code}</td>
							<td>${vo.dataKey}</td>
							<td class="text-ellipsis">${vo.dataValue}</td>
							<td>${vo.dataOrder}</td>
							<td>${vo.dictRemark}</td>
						</tr>
					</c:forEach>
		...
		<script type="text/javascript">
		  $(function(){
      		...
      		$("#addBtn").click(function(){
      			var url = "<%=basePath%>manage/intoPdataDictionary.do";
      			location.href = url;
      			return false;
      		})
      		...
      		$("#updateBtn").click(function(){
      			if(count == 1){
      				$("#manuList").attr("action","<%=basePath%>manage/pdataDictionaryGet.do").submit();
      			}else{
          	...
          	$("#deleteBtn").click(function(){
          		...
          		if(window.confirm("确定删除？")){
	          		$("#manuList").attr("action","<%=basePath%>manage/pdataDictionaryDelete.do").submit();
          		}
      			return false;
          	});
