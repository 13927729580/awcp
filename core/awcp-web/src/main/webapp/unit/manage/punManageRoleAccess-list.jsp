		...
		<script type="text/javascript">
		  $(function(){
      		...
      		$("#addBtn").click(function(){
      			var url = "<%=basePath%>manage/intoPunManageRoleAccess.do";
      			location.href = url;
      			return false;
      		})
      		...
      		$("#updateBtn").click(function(){
      			...
      			if(count == 1){
      				$("#userList").attr("action","<%=basePath%>manage/punManageRoleAccessGet.do").submit();
      			}else{
      				alert("请选择一项进行操作");
      			}
      			return false;
          	...
          	$("#deleteBtn").click(function(){
          		if(window.confirm("确定删除？")){
	          		$("#userList").attr("action","<%=basePath%>manage/punManageRoleAccessDelete.do").submit();
          		}
      			return false;
          	});
          	//updata Access
          	$("#accessBtn").click(function(){
      			...
      			if(count == 1){
      				<%-- $("#userList").attr("action","<%=basePath%>manage/punSysMenuAccessEdit.do").submit(); --%>
