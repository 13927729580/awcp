		...
		<div class="container-fluid">
			...
			<div class="row" id="searchform">
				<div id="collapseButton" class="collapse">
					<form action="<%=basePath%>manage/punManageUserBaseInfoQueryList.do" id="createForm" class="clearfix">
		...
		<script type="text/javascript">
		  $(function(){
      		...
      		$("#addBtn").click(function(){
      			var url = "<%=basePath%>manage/intoPunManageUserBaseInfo.do";
      			location.href = url;
      			return false;
      		})
      		...
      		$("#updateBtn").click(function(){
      			if(count == 1){
      				$("#manuList").attr("action","<%=basePath%>manage/punManageUserBaseInfoGet.do").submit();
      			}else{
          	...
          	$("#deleteBtn").click(function(){
          		...
          		if(window.confirm("确定删除？")){
	          		$("#manuList").attr("action","<%=basePath%>manage/punManageUserBaseInfoDelete.do").submit();
          		}
      			return false;
          	});
