	...
	<div class="container-fluid">
		...
		<div class="row" id="searchform">
			<div id="collapseButton" class="collapse">
				<form action="<%=basePath%>unit/punRoleInfoList.do" id="createForm">
		  ...
		  $(function(){
			  ...
			  $(function(){
		      		...
		      		$("#addBtn").click(function(){
		      			var url = "<%=basePath%>unit/intoPunRoleInfo.do";
		      			location.href = url;
		      			return false;
		      		});
		      		...
		      		$("#updateBtn").click(function(){
		      			if(count == 1){
		      				$("#userList").attr("action","<%=basePath%>unit/punRoleInfoGet.do").submit();
		      			}else{
		      				alert("请选择一个用户进行操作");
		      			}
		      			return false;
		          	...
		          	$("#deleteBtn").click(function(){
		          		...
		          		if(window.confirm("确定删除？")){
		          			$("#userList").attr("action","<%=basePath%>unit/punRoleInfoDelete.do").submit();
		          		}
		      			return false;
		          	});
