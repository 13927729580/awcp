	...
	<body>
		<section class="content">
			<div class="opeBtnGrop">
				<button type="button" class="btn btn-info" id="relateBtn"><i class="icon-edit"></i>关联</button>
			</div>
		  ...
		  $(function(){
			  ...
			  $(".table").bootstrapTable({
		        	 ...
		        	 onPageChange:function(number, size){
		        		...
		        		$("#userList").attr("action","<%=basePath%>unit/roleNotRelateUserQuery.do").submit();
		        	 },
			  ...
			  $("#relateBtn").click(function(){
	      			...
	      			$.ajax({
	    						type : "POST",
	    						url : "<%=basePath%>unit/userRelateRole.do",
	    						async:false,//同步
