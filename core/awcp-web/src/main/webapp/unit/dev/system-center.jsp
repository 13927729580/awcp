...
<script type="text/javascript">
    ...
    var tNodes1 =[
        ...
        { id:95, pId:7, name:"应用商城管理",url:"<%=basePath%>document/view.do?dynamicPageId=23",target:"sysEditFrame"},
        { id:8, pId:0, name:"流程管理",url:null,target:"sysEditFrame",open:true},
        { id:81, pId:8, name:"流程设计器",url:"<%=basePath%>WF/Admin/CCBPMDesigner/Default.htm?UserNo="+$.cookie("userName"),target:"_blank",open:true},
