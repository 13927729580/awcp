...
function(t) {
    ...
    function(t, e, o) {
        ...
        i.extend(r.prototype, {
            ...
            __follow: function(t) {
                ...
                T[1] || (P[T[1]] = "left" === P[T[0]] ? "top": "left", L[1][T[1]] = S[P[T[1]]]),
    ...
    function(t, e, o) {
        ...
        p.create = function(t) {
            ...
            (this.skin && this.skin.indexOf("col-md")!=-1)?this._$("dialog").parent().addClass(this.skin):this._$("dialog").addClass(this.skin),
            ...
            this._esc = function(t) {
                ...
                n = /^input|textarea$/i,
                a = i.current === e,
                s = t.keyCode; ! a || n.test(r) && "button" !== o.type || 27 === s && e._trigger("cancel")
            },
        ...
        r.extend(c, {
            ...
            width: function(t) {
            	if(this.skin && this.skin.indexOf("col-md")!=-1){
            		return this._$("content").css("width", "100%"),
            		this.reset()
            	}else{
    ...
    function(t, e, o) {
        ...
        function n(t) {
            ...
            s[f++] = n >> 8 & 255,
            s[f++] = 255 & n;
            return 2 === a ? (n = l[t.charCodeAt(e)] << 2 | l[t.charCodeAt(e + 1)] >> 4, s[f++] = 255 & n) : 1 === a && (n = l[t.charCodeAt(e)] << 10 | l[t.charCodeAt(e + 1)] << 4 | l[t.charCodeAt(e + 2)] >> 2, s[f++] = n >> 8 & 255, s[f++] = 255 & n),
            s
        }
        function a(t) {
        ...
        function u(t) {
            ...
            r = o % 3,
            i = "",
            n = [], a = 16383, u = 0, l = o - r; u < l; u += a) n.push(s(t, u, u + a > l ? l: u + a));
 ...
 */
            ...
            a.prototype.compare = function(t, e, o, r, i) {
                ...
                for (var n = i - r,
                s = o - e,
                u = Math.min(n, s), f = this.slice(r, i), l = t.slice(e, o), p = 0; p < u; ++p) if (f[p] !== l[p]) {
                    n = f[p],
                    s = l[p];
                    break
                }
            ...
            a.prototype.writeIntLE = function(t, e, o, r) {
                ...
                a = 1,
                s = 0;
                for (this[e] = 255 & t; ++n < o && (a *= 256);) t < 0 && 0 === s && 0 !== this[e + n - 1] && (s = 1),
            ...
            a.prototype.writeIntBE = function(t, e, o, r) {
                ...
                a = 1,
                s = 0;
                for (this[e + n] = 255 & t; --n >= 0 && (a *= 256);) t < 0 && 0 === s && 0 !== this[e + n + 1] && (s = 1),
                this[e + n] = (t / a >> 0) - s & 255;
                return e + o
            },
    ...
    function(t, e, o) {
        ...
        c.create = function(t, e) {
            ...
            p = c.types.start,
            h = function() {},
            d = t.className.replace(/^\s|\s.*/g, "") + "-drag-start",
            g = {
                onstart: h,
                onover: h,
                onend: h,
    ...
    function(t, e, o) {
        ...
        i.oncreate = function(t) {
            ...
            if (a && (this.padding = o.padding = 0, e = r("<iframe />"), e.attr({
                ...
                frameborder: "no",
                scrolling: "auto"	//TODO: scrolling值修改 no->auto
            }).on("load",
            function() {
                var r;
                try {
                ...
                r && (o.width || t.width(e.contents().width()), o.height || t.height(e.contents().height())),
                s && s.call(t)
            }), t.addEventListener("beforeremove",
            function() {
            ...
            r(t.node).on(n.types.start, "[i=title]",
            function(e) {
