...
/* 35 */     if (this == other)
/* 36 */       return true;
/* 37 */     if (!(other instanceof SizeEqCriterion))
/* 38 */       return false;
/* 39 */     SizeEqCriterion castOther = (SizeEqCriterion)other;
 ...
 * Qualified Name:     org.szcloud.framework.core.domain.internal.SizeEqCriterion
