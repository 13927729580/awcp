...
/* 35 */     if (this == other)
/* 36 */       return true;
/* 37 */     if (!(other instanceof GeCriterion))
/* 38 */       return false;
/* 39 */     GeCriterion castOther = (GeCriterion)other;
 ...
 * Qualified Name:     org.szcloud.framework.core.domain.internal.GeCriterion
