...
/* 33 */     if (this == other)
/* 34 */       return true;
/* 35 */     if (!(other instanceof GePropCriterion))
/* 36 */       return false;
/* 37 */     GePropCriterion castOther = (GePropCriterion)other;
 ...
 * Qualified Name:     com.dayatang.domain.internal.GePropCriterion
