...
/* 33 */     if (this == other)
/* 34 */       return true;
/* 35 */     if (!(other instanceof LePropCriterion))
/* 36 */       return false;
/* 37 */     LePropCriterion castOther = (LePropCriterion)other;
 ...
 * Qualified Name:     com.dayatang.domain.internal.LePropCriterion
