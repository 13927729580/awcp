...
/* 35 */     if (this == other)
/* 36 */       return true;
/* 37 */     if (!(other instanceof SizeLeCriterion))
/* 38 */       return false;
/* 39 */     SizeLeCriterion castOther = (SizeLeCriterion)other;
 ...
 * Qualified Name:     org.szcloud.framework.core.domain.internal.SizeLeCriterion
