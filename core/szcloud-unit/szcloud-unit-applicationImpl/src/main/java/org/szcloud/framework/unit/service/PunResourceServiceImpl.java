...
public class PunResourceServiceImpl implements PunResourceService {
	...
	@Override
	public List<PunResourceVO> queryResult(String queryStr,
			Map<String, Object> params)  throws MRTException{
		List<PunResource> resources = queryChannel.queryResult(
				PunResource.class, queryStr, params);
	...
	@Override
	public Map<String, PunResourceVO> queryButtonMap(String queryStr,
	...
	public Long getResourceIdByRelateId(String relateId, String resourceType){
		...
		params.put("resourceType", resourceType);
		List list = this.queryResult("getResourceIdByRelateId", params);
